...
*/
(function(Y, M) { "object" === typeof module && module.exports ? (M["default"] = M, module.exports = Y.document ? M(Y) : M) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() { return M(Y) }) : (Y.Highcharts && Y.Highcharts.error(16, !0), Y.Highcharts = M(Y)) })("undefined" !== typeof window ? window : this, function(Y) {
    function M(a, F, f, G) { a.hasOwnProperty(F) || (a[F] = G.apply(null, f), "function" === typeof CustomEvent && Y.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", { detail: { path: F, module: a[F] } }))) }
    var f = {};
    ...
    M(f, "Core/Utilities.js", [f["Core/Globals.js"]], function(a) {
        ...
        function C(b, c) {
            var r = {};
            v(b, function(x, g) {
                if (I(b[g], !0) && !b.nodeType && c[g]) x = C(b[g], c[g]), Object.keys(x).length && (r[g] = x);
        ...
        function u(b) { return "string" === typeof b }

        function H(b) { b = Object.prototype.toString.call(b); return "[object Array]" === b || "[object Array Iterator]" === b }

        function I(b, c) { return !!b && "object" === typeof b && (!c || !H(b)) }

        function B(b) { return I(b) && "number" === typeof b.nodeType }

        function z(b) { var c = b && b.constructor; return !(!I(b, !0) || B(b) || !c || !c.name || "Object" === c.name) }

        function p(b) { return "number" === typeof b && !isNaN(b) && Infinity > b && -Infinity < b }

        function m(b) { return "undefined" !== typeof b && null !== b }

        function e(b,
            c, g) {
            var r = u(c) && !m(g),
                x, D = function(c, g) { m(c) ? b.setAttribute(g, c) : r ? (x = b.getAttribute(g)) || "class" !== g || (x = b.getAttribute(g + "Name")) : b.removeAttribute(g) };
            u(c) ? D(g, c) : v(c, D);
            return x
        }
        ...
        function l() { for (var b = arguments, c = b.length, g = 0; g < c; g++) { var k = b[g]; if ("undefined" !== typeof k && null !== k) return k } }
        ...
        function v(b, c, g) { for (var r in b) Object.hasOwnProperty.call(b, r) && c.call(g || b[r], b[r], r, b) }
        ...
        function w(b, c, g) {
            ...
            function x(g) {
                ...
                if (b.nodeName) {
                    ...
                    v(L, function(b, c) {
                        if (g[c])
                            for (x = g[c].length; x--;) r(c, g[c][x].fn)
                    })
                }
            }
        ...
        function y(b, c, g, k) {
            ...
            if (q.createEvent && (b.dispatchEvent || b.fireEvent && b !== a)) {
                ...
                g.target || d(g, { preventDefault: function() { g.defaultPrevented = !0 }, target: b, type: c });
                r = [];
                ...
                D && r.sort(function(b, c) { return b.order - c.order });
                r.forEach(function(c) {!1 === c.fn.call(b, g) && g.preventDefault() })
            }
        ...
        var c = Array.prototype.find ? function(b, c) { return b.find(c) } : function(b, c) {
            var r, g = b.length;
            for (r = 0; r < g; r++)
        ...
        var g, b = function() {
            var b = Math.random().toString(36).substring(2, 9) + "-",
                c = 0;
            return function() { return "highcharts-" + (g ? "" : b) + c++ }
        }();
        k.jQuery && (k.jQuery.fn.highcharts = function() { var b = [].slice.call(arguments); if (this[0]) return b[0] ? (new(a[u(b[0]) ? b.shift() : "Chart"])(this[0], b[0], b[1]), this) : A[e(this[0], "data-highcharts-chart")] });
        c = {
            addEvent: function(b,
                c, g, k) {
                void 0 === k && (k = {});
                ...
                x && x.call(b, c, g, a.supportsPassiveEvents ? { passive: void 0 === k.passive ? -1 !== c.indexOf("touch") : k.passive, capture: !1 } : !1);
                r[c] || (r[c] = []);
                r[c].push({ fn: g, order: "number" === typeof k.order ? k.order : Infinity });
                r[c].sort(function(b,
                    c) { return b.order - c.order });
                return function() { w(b, c, g) }
            },
            arrayMax: function(b) { for (var c = b.length, g = b[0]; c--;) b[c] > g && (g = b[c]); return g },
            arrayMin: function(b) { for (var c = b.length, g = b[0]; c--;) b[c] < g && (g = b[c]); return g },
            attr: e,
            clamp: function(b, c, g) { return b > c ? b < g ? b : g : c },
            cleanRecursively: C,
            ...
            getStyle: n,
            inArray: function(b, c, g) { f(32, !1, void 0, { "Highcharts.inArray": "use Array.indexOf" }); return c.indexOf(b, g) },
            isArray: H,
            isClass: z,
            isDOMElement: B,
            ...
            merge: function() {
                var b, c = arguments,
                    ...
                    k = function(b, c) {
                        "object" !== typeof b && (b = {});
                        v(c, function(g, r) { "__proto__" !== r && "constructor" !== r && (!I(g, !0) || z(g) || B(g) ? b[r] = c[r] : b[r] = k(b[r] || {}, g)) });
                        return b
                    };
            ...
            offset: function(b) {
                ...
                return { top: b.top + (k.pageYOffset || c.scrollTop) - (c.clientTop || 0), left: b.left + (k.pageXOffset || c.scrollLeft) - (c.clientLeft || 0), width: b.width, height: b.height }
            },
            pad: function(b, c, g) {
            ...
            pick: l,
            pInt: G,
            relativeLength: function(b, c, g) { return /%$/.test(b) ? c * parseFloat(b) / 100 + (g || 0) : parseFloat(b) },
            removeEvent: w,
            splat: function(b) { return H(b) ? b : [b] },
            stableSort: function(b, c) {
                var g = b.length,
                    k, r;
                for (r = 0; r < g; r++) b[r].safeI = r;
                b.sort(function(b, g) { k = c(b, g); return 0 === k ? b.safeI - g.safeI : k });
            ...
            uniqueKey: b,
            useSerialIds: function(b) { return g = l(b, g) },
            wrap: function(b, c, g) {
                var k = b[c];
                b[c] = function() {
        ...
        f = function() {
            ...
            f.prototype.get = function(a) {
                ...
                if ("object" === typeof B && "undefined" !== typeof this.stops) {
                    ...
                    this.stops.forEach(function(m, e) { p.stops[e] = [p.stops[e][0], m.get(a)] });
                    return p
                }
            ...
            f.prototype.brighten = function(a) {
                ...
                if (this.stops) this.stops.forEach(function(p) { p.brighten(a) });
                    ...
                    for (var z = 0; 3 > z; z++) B[z] += u(255 * a), 0 > B[z] && (B[z] = 0), 255 < B[z] && (B[z] = 255);
                return this
            };
            ...
            f.parsers = [{ regex: /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, parse: function(a) { return [u(a[1]), u(a[2]), u(a[3]), parseFloat(a[4], 10)] } }, { regex: /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, parse: function(a) { return [u(a[1]), u(a[2]), u(a[3]), 1] } }];
            f.None = new f("");
            return f
        }();
        "";
    ...
    M(f, "Core/Color/Palettes.js", [], function() { return { colors: "#7cb5ec #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(" ") } });
        ...
        f = function() {
            ...
            t.prototype.timezoneOffsetFunction = function() {
                var d = this,
                    ...
                    h = e.moment || F.moment;
                if (!this.useUTC) return function(d) { return 6E4 * (new Date(d.toString())).getTimezoneOffset() };
                if (e.timezone) {
                    if (h) return function(d) { return 6E4 * -h.tz(d, e.timezone).utcOffset() };
                    u(25)
                }
                return this.useUTC &&
                    l ? function(d) { return 6E4 * l(d.valueOf()) } : function() { return 6E4 * (d.timezoneOffset || 0) }
            };
            t.prototype.dateFormat = function(d, e, l) {
                ...
                z(n, function(b, c) { for (; - 1 !== d.indexOf("%" + c);) d = d.replace("%" + c, "function" === typeof b ? b.call(h, e) : b) });
                return l ? d.substr(0, 1).toUpperCase() + d.substr(1) : d
            };
            t.prototype.resolveDTLFormat = function(d) { return I(d, !0) ? d : (d = e(d), { main: d[0], from: d[1], to: d[2] }) };
            t.prototype.getTimeTicks =
                function(e, l, h, t) {
                    ...
                    if (G(l)) {
                        ...
                        if (g >=
                            d.month) { n.set("Month", c, g >= d.year ? 0 : b * Math.floor(n.get("Month", c) / b)); var x = n.get("FullYear", c) }
                        ...
                        q.push(l);
                        g <= d.hour && 1E4 > q.length && q.forEach(function(b) { 0 === b % 18E5 && "000000000" === n.dateFormat("%H%M%S%L", b) && (k[b] = "day") })
                    }
            ...
            t.prototype.getDateFormat = function(e, l, h, t) {
                ...
                for (c in d) {
                    if (e === d.week && +this.dateFormat("%w",
                            l) === h && "00:00:00.000" === n.substr(6)) { var c = "week"; break }
                    if (d[c] > e) { c = k; break }
    ...
    M(f, "Core/DefaultOptions.js", [f["Core/Chart/ChartDefaults.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Color/Palettes.js"], f["Core/Time.js"], f["Core/Utilities.js"]], function(a, f, C, G, u, H) {
        ...
        a = {
            ...
            setOptions: function(p) { F(!0, B, p); if (p.time || p.global) C.time ? C.time.update(F(B.global, B.time, p.global, p.time)) : C.time = z; return B }
        };
        "";
        return a
    });
    M(f, "Core/Animation/Fx.js", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, C) {
        ...
        return function() {
            ...
            a.prototype.update = function() {
                ...
                else a.attr ? a.element && a.attr(p, m, null, !0) : a.style[p] = m + this.unit;
                e && e.call(a, m, this)
            };
            a.prototype.run = function(z, p, m) {
                var e = this,
                    d = e.options,
                    l = function(d) { return l.stopped ? !1 : e.step(d) },
                    h = u.requestAnimationFrame || function(d) { setTimeout(d, 13) },
                    t = function() {
            ...
            a.prototype.initPath = function(a, p, m) {
                ...
                if (l && h && h.length) {
                    for (a = 0; a < l.length; a++)
                        if (l[a] === h[0]) { var v = a; break } else if (l[0] ===
                        h[h.length - l.length + a]) { v = a; var w = !0; break } else if (l[l.length - 1] === h[h.length - l.length + a]) { v = l.length - a; break }
            ...
            a.prototype.strokeSetter = function() { this.elem.attr(this.prop, F(this.start).tweenTo(F(this.end), this.pos), void 0, !0) };
            a.timers = [];
            return a
        }()
    });
    M(f, "Core/Animation/AnimationUtilities.js", [f["Core/Animation/Fx.js"],
        ...
        function F(d) { return z(d) ? p({ duration: 500, defer: 0 }, d) : { duration: d ? 500 : 0, defer: 0 } }

        function G(d, e) { for (var l = a.timers.length; l--;) a.timers[l].elem !== d || e && e !== a.timers[l].prop || (a.timers[l].stopped = !0) }
        var u = f.defined,
            H = f.getStyle,
            I = f.isArray,
            B = f.isNumber,
        ...
        return {
            ...
            setAnimation: function(d, l) { l.renderer.globalAnimation = e(d, l.options.chart.animation, !0) },
            stop: G
        }
    });
    M(f, "Core/Renderer/HTML/AST.js", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        var F = a.SVG_NS,
            ...
            p = f.objectEach,
            m = f.splat,
            e = (f = a.win.trustedTypes) && B(f.createPolicy) && f.createPolicy("highcharts", { createHTML: function(d) { return d } }),
            d = e ? e.createHTML("") : "";
        try { var l = !!(new DOMParser).parseFromString(d, "text/html") } catch (h) { l = !1 }
        B = function() {
            function h(d) { this.nodes = "string" === typeof d ? this.parseMarkup(d) : d }
            h.filterUserAttributes = function(d) {
                p(d, function(e, l) {
                    var n = !0; - 1 === h.allowedAttributes.indexOf(l) && (n = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(l) && (n = z(e) && h.allowedReferences.some(function(d) { return 0 === e.indexOf(d) }));
            ...
            h.parseStyle = function(d) {
                return d.split(";").reduce(function(d, e) {
                    ...
                    var l = e[0].replace(/-([a-z])/g, function(d) { return d[1].toUpperCase() });
                    e[1] && (d[l] = e[1]);
                    return d
                }, {})
            };
                ...
                function e(d, l) {
                    ...
                    m(d).forEach(function(d) {
                        ...
                        if (q)
                            ...
                            var b = d.attributes || {};
                            p(d, function(c, g) { "tagName" !== g && "attributes" !== g && "children" !== g && "style" !== g && "textContent" !== g && (b[g] = c) });
            ...
            h.prototype.parseMarkup =
                function(d) {
                    ...
                    if (l) d = (new DOMParser).parseFromString(e ? e.createHTML(d) : d, "text/html");
                    else {
                        var a = u("div");
                        a.innerHTML = d;
                        d = { body: a }
                    ...
                    var t = function(d, e) {
                        ...
                        if (q = d.attributes) {
                            var c = {};
                            [].forEach.call(q, function(b) { "data-style" === b.name ? k.style = h.parseStyle(b.value) : c[b.name] = b.value });
                            k.attributes = c
                        }
                    ...
                    [].forEach.call(d.body.childNodes, function(d) { return t(d, n) });
                    return n
                };
    ...
    M(f, "Core/FormatUtilities.js", [f["Core/DefaultOptions.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        var G = a.defaultOptions,
            ...
            z = f.pInt;
        return {
            dateFormat: function(a, m, e) { return u.dateFormat(a, m, e) },
        ...
        function(a) {
            ...
            (function(a) {
                function F(a, z, p) {
                    var m = a,
                        e = m.reducedLen || z,
                        d = function(d, e) { return (e.rank || 0) - (d.rank || 0) },
                        l = function(d, e) { return d.target - e.target },
                        h, t = !0,
                        n = [],
                        v = 0;
                    ...
                    G(a, l);
                    for (a = a.map(function(d) { return { size: d.size, targets: [d.target], align: C(d.align, .5) } }); t;) {
                    ...
                    a.some(function(d) {
                        ...
                        return (d.targets || []).some(function() {
                            m[h].pos = d.pos + e;
                            if ("undefined" !== typeof p && Math.abs(m[h].pos - m[h].target) > p) return m.slice(0, h + 1).forEach(function(d) { return delete d.pos }), m.reducedLen =
    ...
    M(f, "Core/Renderer/SVG/SVGElement.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, C, G, u) {
        ...
        a = function() {
            ...
            a.prototype._defaultSetter = function(b, c, g) { g.setAttribute(c, b) };
            ...
            a.prototype.addClass = function(b, c) {
                var g = c ? "" : this.attr("class") ||
                    "";
                b = (b || "").split(/ /g).reduce(function(b, c) {-1 === g.indexOf(c) && b.push(c); return b }, g ? [g] : []).join(" ");
            ...
            a.prototype.align = function(c, g, d) {
                var L = {},
                    ...
                    r = k.alignedObjects,
                    e, q, E;
                if (c) { if (this.alignOptions = c, this.alignByTranslate = g, !d || b(d)) this.alignTo = e = d || "renderer", y(r, this), r.push(this), d = void 0 } else c = this.alignOptions, g = this.alignByTranslate,
                    e = this.alignTo;
            ...
            a.prototype.animate = function(b, c, g) {
                ...
                0 !== L.duration ? (g && (L.complete = g), P(function() { d.element && F(d, b, L) }, c)) : (this.attr(b, void 0, g || L.complete), x(b, function(b, c) { L.step && L.step.call(this, b, { prop: c, pos: 1, elem: this }) }, this));
                return this
            };
            a.prototype.applyTextOutline = function(b) {
                ...
                if ((g = g[0]) && "none" !== g && G.svg) {
                    ...
                    g = g.replace(/(^[\d\.]+)(.*?)$/g, function(b, c, g) { return 2 * Number(c) + g });
                    this.removeTextOutline();
                    var k = p.createElementNS(d, "tspan");
                    t(k, { "class": "highcharts-text-outline", fill: b, stroke: b, "stroke-width": g, "stroke-linejoin": "round" });
                    [].forEach.call(c.childNodes, function(b) {
                        var c = b.cloneNode(!0);
                        c.removeAttribute && ["fill", "stroke", "stroke-width", "stroke"].forEach(function(b) { return c.removeAttribute(b) });
                        k.appendChild(c)
                    });
            ...
            a.prototype.complexColor = function(b, c, g) {
                ...
                q(this.renderer, "complexColor", { args: arguments }, function() {
                    ...
                    if (e) {
                        ...
                        x(a, function(b, c) { "id" !== c && y.push(c, b) });
                        x(n, function(b) { y.push(b) });
                        y = y.join(",");
                        if (E[y]) m = E[y].attr("id");
                            ...
                            n.forEach(function(b) {
                                ...
                                b = d.createElement("stop").attr({ offset: b[0], "stop-color": h, "stop-opacity": D }).add(J);
                                J.stops.push(b)
                            })
                        }
                        A = "url(" + d.url + "#" + m + ")";
            ...
            a.prototype.css = function(b) {
                ...
                c && x(b, function(b, d) { c && c[d] !== b && (g[d] = b, k = !0) });
                if (k) {
                    c && (b = A(c, g));
                    ...
                    var q = r(b);
                    d.namespaceURI === this.SVG_NS && ["textOutline", "textOverflow", "width"].forEach(function(b) { return q && delete q[b] });
                    v(d, q);
            ...
            a.prototype.destroy = function() {
                ...
                if (b.clipPath && d) {
                    var r = b.clipPath;
                    [].forEach.call(d.querySelectorAll("[clip-path],[CLIP-PATH]"), function(b) {-1 < b.getAttribute("clip-path").indexOf(r.element.id) && b.removeAttribute("clip-path") });
            ...
            a.prototype.fadeOut = function(b) {
                var c = this;
                c.animate({ opacity: 0 }, { duration: D(b, 150), complete: function() { c.attr({ y: -9999 }).hide() } })
            };
            a.prototype.fillSetter = function(b, c, g) { "string" === typeof b ? g.setAttribute(c, b) : b && this.complexColor(b, c, g) };
            a.prototype.getBBox = function(b, g) {
                ...
                var n = d.styledMode ? k && a.prototype.getStyle.call(k, "font-size") : r && r.fontSize,
                    x;
                if (w(e)) {
                    var h = e.toString(); - 1 === h.indexOf("<") && (h = h.replace(/[0-9]/g, "0"));
                ...
                if (!x) {
                    ...
                    d.isSVG && (b = x.width, d = x.height, E && (x.height = d = { "11px,17": 14, "13px,20": 16 }[(n || "") + "," + Math.round(d)] || d), g && (E = g * z, x.width = Math.abs(d * Math.sin(E)) + Math.abs(b * Math.cos(E)), x.height = Math.abs(d * Math.cos(E)) + Math.abs(b * Math.sin(E))));
                    if (h && ("" === e || 0 < x.height)) {
            ...
            a.prototype.getStyle = function(b) { return l.getComputedStyle(this.element || this, "").getPropertyValue(b) };
            ...
            a.prototype.removeClass = function(c) { return this.attr("class", ("" + this.attr("class")).replace(b(c) ? new RegExp("(^| )" + c + "( |$)") : c, " ").replace(/ +/g, " ").trim()) };
            ...
            a.prototype.setTextPath = function(b, c) {
                ...
                if (b && c && c.enabled) {
                    ...
                    if (n)
                        for (k.setAttribute("y", 0), g(E.dx) && k.setAttribute("x", -E.dx), b = [].slice.call(k.childNodes), n = 0; n < b.length; n++) {
                            var D = b[n];
                    ...
                    x(E, function(b, c) { h.setAttribute(e[c] || c, b) });
            ...
            a.prototype.shadow = function(b, c, g) {
                ...
                E && (E && L && x(E, function(b, c) { b !== L[c] && (e = !0) }), e && this.destroyShadows(), this.oldShadowOptions =
                    E);
                if (!E) this.destroyShadows();
                    ...
                    for (r = 1; r <= E.width; r++) {
                        ...
                        t(l, { stroke: b.color || "#000000", "stroke-opacity": a * r, "stroke-width": n, transform: q, fill: "none" });
            ...
            a.prototype.translate = function(b, c) { return this.attr({ translateX: b, translateY: c }) };
            a.prototype.updateShadows = function(b, c, g) {
                var d = this.shadows;
                if (d)
                    for (var k = d.length; k--;) g.call(d[k], "height" === b ? Math.max(c - (d[k].cutHeight || 0), 0) : "d" === b ? this.d : c, b, d[k])
            };
                ...
                if (a) {
                    ...
                    for (E = c.length - 1; 0 <=
                        ...
                        if (d !== r)
                            ...
                            else if (K(a) <= b || q && (!w(b) || 0 <= b)) k.insertBefore(r, c[E + 1] || null), e = !0
                    }
    ...
    M(f, "Core/Renderer/RendererRegistry.js", [f["Core/Globals.js"]], function(a) {
        ...
        (function(f) {
            f.rendererTypes = {};
            var F;
            f.getRendererType = function(a) { void 0 === a && (a = F); return f.rendererTypes[a] || f.rendererTypes[F] };
            f.registerRendererType = function(u, C, I) { f.rendererTypes[u] = C; if (!F || I) F = u, a.Renderer = C }
        })(f || (f = {}));
        return f
    });
    M(f, "Core/Renderer/SVG/SVGLabel.js", [f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f) {
        var F = this && this.__extends || function() {
                var a = function(m, e) {
                    ...
                    instanceof Array && function(d, e) { d.__proto__ = e } || function(d, e) { for (var a in e) e.hasOwnProperty(a) && (d[a] = e[a]) };
                    return a(m, e)
                };
                return function(m, e) {
                    function d() { this.constructor = m }
                    a(m, e);
        ...
        return function(p) {
            ...
            m.prototype.boxAttr = function(e,
                d) { this.box ? this.box.attr(e, d) : this.deferredAttr[e] = d };
            m.prototype.css = function(e) {
                if (e) {
                    var d = {};
                    e = I(e);
                    m.textProps.forEach(function(a) { "undefined" !== typeof e[a] && (d[a] = e[a], delete e[a]) });
                    this.text.css(d);
                    var l = "width" in d;
            ...
            m.prototype.heightSetter = function(e) { this.heightSetting = e };
            ...
            m.prototype.paddingSetter = function(e, d) { H(e) ? e !== this[d] && (this[d] = e, this.updateTextPadding()) : this[d] = void 0 };
            m.prototype.rSetter = function(e, d) { this.boxAttr(d, e) };
            ...
            m.prototype["text-alignSetter"] = function(e) { this.textAlign = e };
            ...
            m.prototype.updateBoxSize = function() {
                var e = this.text.element.style,
                    d = {},
                    a = this.padding,
                    h = this.bBox = H(this.widthSetting) &&
            ...
            m.prototype.updateTextPadding = function() {
                ...
                G(this.widthSetting) && this.bBox &&
                    ("center" === this.textAlign || "right" === this.textAlign) && (l += { center: .5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width));
                if (l !== a.x || d !== a.y) a.attr("x", l), a.hasBoxWidthChanged && (this.bBox = a.getBBox(!0)), "undefined" !== typeof d && a.attr("y", d);
                a.x = l;
                a.y = d
            };
            m.prototype.widthSetter = function(a) { this.widthSetting = H(a) ? a : void 0 };
    ...
    M(f, "Core/Renderer/SVG/Symbols.js", [f["Core/Utilities.js"]], function(a) {
        ...
        return {
            ...
            circle: function(a,
                z, p, m) { return f(a + p / 2, z + m / 2, p / 2, m / 2, { start: .5 * Math.PI, end: 2.5 * Math.PI, open: !1 }) },
        ...
        return function() {
            ...
            e.prototype.modifyDOM = function() {
                ...
                for (var t; t = a.element.firstChild;)
                    if (/^[\s\u200B]*$/.test(t.textContent || " ")) a.element.removeChild(t);
                    else break;
                    [].forEach.call(a.element.querySelectorAll("tspan.highcharts-br"),
                    function(n, h) { n.nextSibling && n.previousSibling && (0 === h && 1 === n.previousSibling.nodeType && (a.firstLineMetrics = a.renderer.fontMetrics(void 0, n.previousSibling)), I(n, { dy: d.getLineHeight(n.nextSibling), x: e })) });
                var n = this.width || 0;
                if (n) {
                    var f = function(h, l) {
                            var q = h.textContent || "",
                            ...
                            if (d.ellipsis) q && d.truncate(h, q, void 0, 0, Math.max(0, n - parseInt(d.fontSize || 12, 10)), function(b,
                                c) { return b.substring(0, c) + "\u2026" });
                            else if (c) {
                                q = [];
                                for (c = []; l.firstChild && l.firstChild !== h;) c.push(l.firstChild), l.removeChild(l.firstChild);
                                for (; k.length;) k.length && !d.noWrap && 0 < b && (q.push(h.textContent || ""), h.textContent = k.join(" ").replace(/- /g, "-")), d.truncate(h, void 0, k, 0 === b ? r || 0 : 0, n, function(b, c) { return k.slice(0, c).join(" ").replace(/- /g, "-") }), r = a.actualWidth, b++;
                                c.forEach(function(b) { l.insertBefore(b, h) });
                        ...
                        m = function(d) {
                            [].slice.call(d.childNodes).forEach(function(e) { e.nodeType === H.Node.TEXT_NODE ? f(e, d) : (-1 !== e.className.baseVal.indexOf("highcharts-br") && (a.actualWidth = 0), m(e)) })
                        };
                    m(a.element)
                }
            };
            ...
            e.prototype.modifyTree = function(d) {
                var a = this,
                    e = function(h, n) {
                        ...
                        if ("b" === m || "strong" === m) q ? l["class"] = "highcharts-strong" : t.fontWeight = "bold";
                        else if ("i" === m || "em" === m) q ? l["class"] = "highcharts-emphasized" : t.fontStyle = "italic";
                        t && t.color && (t.fill = t.color);
                        "br" === m ? (l["class"] = "highcharts-br",
                            h.textContent = "\u200b", (n = d[n + 1]) && n.textContent && (n.textContent = n.textContent.replace(/^ +/gm, ""))) : "a" === m && f && f.some(function(d) { return "#text" === d.tagName }) && (h.children = [{ children: f, tagName: "tspan" }]);
                        "#text" !== m && "a" !== m && (h.tagName = "tspan");
                        B(h, { attributes: l, style: t });
                        f && f.filter(function(d) { return "#text" !== d.tagName }).forEach(e)
                    };
                d.forEach(e)
            };
                ...
                var h = this.svgElement,
                    ...
                    b, r = function(b, c) {
                        ...
                        if (g && "undefined" === typeof q[c])
                            if (g.getSubStringLength) try { q[c] = t + g.getSubStringLength(0, e ? c + 1 : c) } catch (Q) { "" } else l.getSpanWidth && (d.textContent = f(a || e, b), q[c] = t + l.getSpanWidth(h, d));
                        return q[c]
                    };
                h.rotation = 0;
            ...
            e.prototype.unescapeEntities =
                function(d, a) { p(this.renderer.escapes, function(e, l) { a && -1 !== a.indexOf(e) || (d = d.toString().replace(new RegExp(e, "g"), l)) }); return d };
            return e
        }()
    });
    M(f, "Core/Renderer/SVG/SVGRenderer.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGLabel.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Renderer/SVG/TextBuilder.js"], f["Core/Utilities.js"]], function(a, f, C, G, u, H, I, B, z) {
        ...
        C = function() {
            ...
            L.prototype.init = function(b, c, g, a, r, E, L) {
                var q = this.createElement("svg").attr({ version: "1.1", "class": "highcharts-root" }),
                    J = q.element;
                L || q.css(this.getStyle(a));
                b.appendChild(J);
                A(b, "dir", "ltr"); - 1 === b.innerHTML.indexOf("xmlns") && A(J, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = J;
                this.boxWrapper = q;
                this.alignedObjects = [];
            ...
            L.prototype.definition = function(b) { return (new a([b])).addToDOM(this.defs.element) };
            L.prototype.getReferenceURL =
                function() {
                    if ((d || h) && e.getElementsByTagName("base").length) {
                        if (!c(Z)) {
                            var b = F();
                            b = (new a([{ tagName: "svg", attributes: { width: 8, height: 8 }, children: [{ tagName: "defs", children: [{ tagName: "clipPath", attributes: { id: b }, children: [{ tagName: "rect", attributes: { width: 4, height: 4 } }] }] }, { tagName: "rect", attributes: { id: "hitme", width: 8, height: 8, "clip-path": "url(#" + b + ")", fill: "rgba(0,0,0,0.001)" } }] }])).addToDOM(e.body);
            ...
            L.prototype.getStyle = function(c) { return this.style = b({ fontFamily: '"Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif', fontSize: "12px" }, c) };
            L.prototype.setStyle = function(b) { this.boxWrapper.css(this.getStyle(b)) };
            L.prototype.isHidden = function() { return !this.boxWrapper.getBBox().width };
            ...
            L.prototype.getRadialAttr = function(b, c) { return { cx: b[0] - b[2] / 2 + (c.cx || 0) * b[2], cy: b[1] - b[2] / 2 + (c.cy || 0) * b[2], r: (c.r || 0) * b[2] } };
            ...
            L.prototype.button = function(c, g, d, k, e, r, L, q, n, h) {
                var E = this.label(c, g, d, n, void 0, void 0, h, void 0, "button"),
                    ...
                    J = 0,
                    f = e ? P(e) : {},
                    t = P({ color: "#333333", cursor: "pointer", fontWeight: "normal" }, f.style);
                delete f.style;
                ...
                if (!x) {
                    ...
                    var N = r.style;
                    delete r.style;
                    L = P(f, { fill: "#e6ebf5", style: { color: "#000000", fontWeight: "bold" } }, a.filterUserAttributes(L || {}));
                    var m = L.style;
                    delete L.style;
                ...
                y(E.element, l ? "mouseover" : "mouseenter", function() { 3 !== J && E.setState(1) });
                y(E.element, l ? "mouseout" : "mouseleave", function() { 3 !== J && E.setState(J) });
                ...
                return E.on("touchstart", function(b) { return b.stopPropagation() }).on("click", function(b) { 3 !== J && k.call(E, b) })
            };
            ...
            L.prototype.circle = function(b, c, g) {
                ...
                c.xSetter = c.ySetter = function(b, c, g) { g.setAttribute("c" + c, b) };
                return c.attr(b)
            };
            ...
            L.prototype.rect = function(b, c, g, d, a, k) {
                ...
                b = D(b) ? b : "undefined" === typeof b ? {} : { x: b, y: c, width: Math.max(g, 0), height: Math.max(d, 0) };
            ...
            L.prototype.g = function(b) { var c = this.createElement("g"); return b ? c.attr({ "class": "highcharts-" + b }) : c };
            L.prototype.image = function(b, c, g, d, a, k) {
                var e = { preserveAspectRatio: "none" },
                    r = function(b, c) { b.setAttributeNS ? b.setAttributeNS("http://www.w3.org/1999/xlink", "href", c) : b.setAttribute("hc-svg-href", c) };
                x(c) && (e.x = c);
                x(g) && (e.y = g);
                x(d) && (e.width = d);
                x(a) && (e.height = a);
            ...
            L.prototype.pathToSegments = function(b) {
                for (var c = [], g = [], d = { A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2 }, a = 0; a < b.length; a++) K(g[0]) && x(b[a]) && g.length === d[g[0].toUpperCase()] && b.splice(a, 0, g[0].replace("M", "L").replace("m", "l")), "string" === typeof b[a] && (g.length && c.push(g.slice(0)), g.length = 0), g.push(b[a]);
                c.push(g.slice(0));
                return c
            };
            L.prototype.label = function(b, c, g, d, a, k, e, r, L) { return new H(this, b, c, g, d, a, k, e, r, L) };
            L.prototype.alignElements =
                function() { this.alignedObjects.forEach(function(b) { return b.align() }) };
            return L
        }();
    ...
    M(f, "Core/Renderer/HTML/HTMLElement.js", [f["Core/Globals.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f, C) {
        var F = this && this.__extends || function() {
                var d = function(a, e) {
                    ...
                    instanceof
                    Array && function(d, a) { d.__proto__ = a } || function(d, a) { for (var e in a) a.hasOwnProperty(e) && (d[e] = a[e]) };
                    return d(a, e)
                };
                return function(a, e) {
        ...
        return function(a) {
            ...
            h.prototype.htmlGetBBox = function() { var d = this.element; return { x: d.offsetLeft, y: d.offsetTop, width: d.offsetWidth, height: d.offsetHeight } };
            h.prototype.htmlUpdateTransform = function() {
                if (this.added) {
                    var a = this.renderer,
                        ...
                        k = { left: 0, center: .5, right: 1 }[q],
                        c = this.styles;
                    c = c && c.whiteSpace;
                    z(e, { marginLeft: h, marginTop: l });
                    !a.styledMode && this.shadows && this.shadows.forEach(function(b) { z(b, { marginLeft: h + 1, marginTop: l + 1 }) });
                    ...
                    if ("SPAN" === e.tagName) {
                        ...
                        if (b !== this.oldTextWidth) {
                            ...
                            else z(e, { width: "", whiteSpace: c || "nowrap" }), D = e.offsetWidth;
                            (b > this.oldTextWidth || D > b) && (/[ \-]/.test(e.textContent ||
                                e.innerText) || "ellipsis" === e.style.textOverflow) && (z(e, { width: D > b || g ? b + "px" : "auto", display: "block", whiteSpace: c || "normal" }), this.oldTextWidth = b, x = !0)
                        }
    ...
    M(f, "Core/Renderer/HTML/HTMLRenderer.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGRenderer.js"], f["Core/Utilities.js"]],
        function(a, f, C, G) {
            var F = this && this.__extends || function() {
                    var a = function(f, e) {
                        a = Object.setPrototypeOf || { __proto__: [] }
                        instanceof Array && function(d, a) { d.__proto__ = a } || function(d, a) { for (var e in a) a.hasOwnProperty(e) && (d[e] = a[e]) };
                        return a(f, e)
                    };
                    return function(f, e) {
                        function d() { this.constructor = f }
                        a(f, e);
                ...
                z = G.pick;
            return function(p) {
                function m() { return null !== p && p.apply(this, arguments) || this }
                F(m, p);
                m.compose = function(a) {-1 === m.composedClasses.indexOf(a) && (m.composedClasses.push(a), a.prototype.html = m.prototype.html); return a };
                            ...
                            if (!k) {
                                ...
                                e.reverse().forEach(function(c) {
                                    ...
                                    B(c, {
                                        ...
                                        on: function() { e[0].div && h.on.apply({ element: e[0].div, onEvents: c.onEvents }, arguments); return c },
                                        translateXSetter: g,
                                        translateYSetter: g
                                    });
                                    c.addedSetters || w(c)
    ...
    M(f, "Core/Foundation.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            a.registerEventOptions = function(a, z) {
                ...
                G(z.events, function(p, m) { a.eventOptions[m] !== p && (a.eventOptions[m] && (u(a, m, a.eventOptions[m]), delete a.eventOptions[m]), C(p) && (a.eventOptions[m] = p, f(a, m, p))) })
            }
        })(H || (H = {}));
        return H
    });
        ...
        function(a, f, C) {
            ...
            f = function() {
                ...
                h.prototype.addLabel = function() {
                    ...
                    if (e.dateTime)
                        if (g) { var P = f.time.resolveDTLFormat(h.dateTimeLabelFormats[!h.grid && g.higherRanks[k] || g.unitName]); var Q = P.main } else m(y) && (Q = e.dateTime.getXDateFormat(y, h.dateTimeLabelFormats || {}));
                    d.isFirst = b;
                    d.isLast = r;
                    var O = {
                        axis: e,
                    ...
                    var B = function(b) { return c.formatter ? c.formatter.call(b, b) : c.format ? (b.text = e.defaultLabelFormatter.call(b), a.format(c.format, b, f)) : e.defaultLabelFormatter.call(b, b) };
                    h = B.call(O, O);
                    var F = P && P.list;
                    d.shortenLabel = F ? function() {
                        for (K = 0; K < F.length; K++)
                            if (z(O, { dateTimeLabelFormat: F[K] }), D.attr({ text: B.call(O, O) }), D.getBBox().width < e.getSlotWidth(d) - 2 * c.padding) return;
                        D.attr({ text: "" })
                    } : void 0;
                    x && e._addedPlotLB && d.moveLabel(h, c);
                    I(D) || d.movedLabel ? D && D.textStr !== h && !x && (!D.textWidth || c.style.width || D.styles.width || D.css({ width: null }), D.attr({ text: h }), D.textPxLength = D.getBBox().width) : (d.label = D = d.createLabel({ x: 0, y: 0 }, h, c), d.rotation = 0)
                };
                ...
                h.prototype.getPosition = function(d, a, e, h) {
                    ...
                    d = { x: d ? H(f.translate(a + e, null, null, h) + f.transB) : f.left + f.offset + (f.opposite ? (h && n.oldChartWidth || n.chartWidth) - f.right - f.left : 0), y: d ? q - f.bottom + f.offset - (f.opposite ? f.height : 0) : H(q - f.translate(a + e, null, null, h) - f.transB) };
                    d.y = u(d.y, -1E5, 1E5);
                ...
                h.prototype.getLabelPosition = function(d, a, e, h, f, l, q, k) {
                    var c = this.axis,
                        g = c.transA,
                        b = c.isLinked && c.linkedParent ?
                        c.linkedParent.reversed : c.reversed,
                        r = c.staggerLines,
                ...
                h.prototype.handleOverflow = function(d) {
                    ...
                    var k = this.label,
                        c = this.rotation,
                        g = { left: 0, center: .5, right: 1 }[a.labelAlign ||
                            k.attr("align")
                        ],
                        b = k.getBBox().width,
                        ...
                        p = 1,
                        t;
                    if (c || "justify" !== e.overflow) 0 > c && h - g * b < q ? t = Math.round(h / Math.cos(c * F) - q) : 0 < c && h + g * b > m && (t = Math.round((f - h) / Math.cos(c * F)));
                    else if (f = h + (1 - g) * b, h - g * b < q ? D = d.x + D * (1 - g) - q : f > m && (D = m - d.x + D * g, p = -1), D = Math.min(r, D), D < r && "center" === a.labelAlign && (d.x += p * (r - D - g * (r - Math.min(b, D)))), b > D || a.autoRotation && (k.styles || {}).width) t = D;
                ...
                h.prototype.moveLabel = function(a, e) {
                    var h = this,
                        ...
                        n = l.reversed,
                        q = !1;
                    f && f.textStr === a ? (h.movedLabel = f, q = !0, delete h.label) : d(l.ticks, function(c) { q || c.isNew || c === h || !c.label || c.label.textStr !== a || (h.movedLabel = c.label, q = !0, c.labelPos = h.movedLabel.xy, delete c.label) });
                    if (!q && (h.labelPos || f)) {
                ...
                h.prototype.renderMark = function(d, a, e) {
                    ...
                    var b = this.mark,
                        r = !b;
                    k && (h.opposite && (k[0] = -k[0]), b || (this.mark = b = n.path().addClass("highcharts-" + (q ? q + "-" : "") + "tick").add(h.axisGroup), h.chart.styledMode || b.attr({ stroke: f, "stroke-width": g })), b[r ? "attr" : "animate"]({
                        d: this.getMarkPath(c,
                            d, k[0], b.strokeWidth() * e, h.horiz, n),
                        opacity: a
                    }))
                };
    ...
    M(f, "Core/Axis/Axis.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/AxisDefaults.js"],
        f["Core/Color/Color.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Axis/Tick.js"], f["Core/Utilities.js"]
        ...
        a = function() {
            ...
            a.prototype.defaultLabelFormatter =
                function(b) {
                    ...
                    if (c.categories) var L = "" + this.value;
                        ...
                        for (; q-- && "undefined" === typeof L;) c = Math.pow(k, q + 1), h >= c && 0 === 10 * a % c && null !== r[q] && 0 !== a && (L = b(a / c, -1) + r[q]);
            ...
            a.prototype.toValue = function(b, c) { return this.translate(b - (c ? 0 : this.pos), !0, !this.horiz, null, !0) };
            a.prototype.getPlotLinePath = function(b) {
                function c(b, c, a) { if ("pass" !== m && b < c || b > a) m ? b = h(b, c, a) : w = !0; return b }
                var a = this,
                    d = a.chart,
                    e = a.left,
                    k = a.top,
                ...
                q(this, "getPlotLinePath", b, function(b) {
                    ...
                    b.path = w && !m ? null : d.renderer.crispLine([
                        ["M", p, t],
                        ["L", A, P]
                    ], L || 1)
                });
            ...
            a.prototype.getMinorTickInterval = function() { var b = this.options; return !0 === b.minorTicks ? K(b.minorTickInterval, "auto") : !1 === b.minorTicks ? null : b.minorTickInterval };
            a.prototype.getMinorTickPositions = function() {
                ...
                if (e && e / a < this.len / 3) {
                    ...
                    else if (this.dateTime && "auto" === this.getMinorTickInterval()) k = k.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(a), g, d, b.startOfWeek));
                    else
                        for (b = g + (c[0] - g) % a; b <= d && b !== k[0]; b += a) k.push(b)
                }
            ...
            a.prototype.nameToX = function(b) {
                ...
                if (-1 === g) { if (!a && d) var e = d.length } else e = g;
            ...
            a.prototype.updateNames = function() {
                var b = this,
                    c = this.names;
                0 < c.length && (Object.keys(c.keys).forEach(function(b) { delete c.keys[b] }), c.length = 0, this.minRange = this.userMinRange, (this.series || []).forEach(function(c) {
                    c.xIncrement = null;
                    if (!c.points || c.isDirtyData) b.max = Math.max(b.max, c.xData.length - 1), c.processData(), c.generatePoints();
                    c.data.forEach(function(a,
                        d) { if (a && a.options && "undefined" !== typeof a.name) { var g = b.nameToX(a); "undefined" !== typeof g && g !== a.x && (a.x = g, c.xData[d] = g) } })
                }))
            };
            ...
            a.prototype.setTickInterval = function(b) {
                ...
                b = K(d.minTickInterval, this.dateTime && !this.series.some(function(b) { return b.noSharedTooltip }) ? this.closestPointRange : 0);
            ...
            a.prototype.setTickPositions = function() {
                ...
                this.isLinked || (this.single && 2 > a.length && !this.categories && !this.series.some(function(b) { return b.is("heatmap") && "between" === b.options.pointPlacement }) && (this.min -= .5, this.max += .5), c || g || this.adjustTickAmount());
            ...
            a.prototype.alignToOthers = function() {
                ...
                if ((!1 !== this.chart.options.chart.alignTicks && a.alignTicks || d) && !1 !== a.startOnTick && !1 !== a.endOnTick && !b.logarithmic) {
                    var r = function(b) { var c = b.options; return [b.horiz ? c.left : c.top, c.width, c.height, c.pane].join() },
                        h = r(this);
                    this.chart[this.coll].forEach(function(a) {
                        var d = a.series;
                        d.length && d.some(function(b) { return b.visible }) && a !== b && r(a) === h && (k = !0, c.push(a))
                    })
                }
                if (k && d) {
                    ...
                    var q = 1 < e.length ? e.reduce(function(b, c) { return b + c },
                        0) / e.length : void 0;
                    c.forEach(function(b) { b.thresholdAlignment = q })
                }
                return k
            };
            a.prototype.getThresholdAlignment = function(b) {
                (!g(this.dataMin) || this !== b && this.series.some(function(b) { return b.isDirty || b.isDirtyData })) && this.getSeriesExtremes();
            ...
            a.prototype.getExtremes = function() { var b = this.logarithmic; return { min: b ? t(b.lin2log(this.min)) : this.min, max: b ? t(b.lin2log(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax } };
            ...
            a.prototype.autoLabelAlign =
                function(b) {
                    ...
                    b = { align: "center" };
                    q(this, "autoLabelAlign", b, function(b) { 15 < c && 165 > c ? b.align = "right" : 195 < c && 345 > c && (b.align = "left") });
                    return b.align
                };
            a.prototype.tickSize = function(b) {
                ...
                if (a && d) { "inside" === c[b + "Position"] && (d = -d); var g = [d, a] }
                b = { tickSize: g };
            ...
            a.prototype.getSlotWidth = function(b) {
                ...
                if (!a) { b = d.style.width; if (void 0 !== b) return parseInt(String(b), 10); if (k) return k - c.spacing[3] }
            ...
            a.prototype.renderUnsquish = function() {
                ...
                if (this.autoRotation) D > q && D > x.h ? f.rotation = this.labelRotation : this.labelRotation = 0;
                else if (h) {
                    var n = q;
                    if (!l) {
                        var m = "clip";
            ...
            a.prototype.hasData = function() { return this.series.some(function(b) { return b.hasData() }) || this.options.showEmpty && n(this.min) && n(this.max) };
            a.prototype.addTitle = function(b) {
                var c = this.chart.renderer,
                    ...
                    k;
                this.axisTitle || ((k = g.textAlign) || (k = (a ? { low: "left", middle: "center", high: "right" } : { low: d ? "right" : "left", middle: "center", high: d ? "left" : "right" })[g.align]), this.axisTitle = c.text(g.text || "", 0, 0, g.useHTML).attr({ zIndex: 7, rotation: g.rotation, align: k }).addClass("highcharts-axis-title"), e || this.axisTitle.css(r(g.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0);
            ...
            a.prototype.getLinePath = function(b) {
                ...
                return c.renderer.crispLine([
                    ["M", g ?
                        this.left : e, g ? d : this.top
                    ],
                    ["L", g ? c.chartWidth - this.right : e, g ? d : c.chartHeight - this.bottom]
                ], b)
            };
            ...
            a.prototype.renderTick = function(b, c, a) { var d = this.ticks; if (!this.isLinked || b >= this.min && b <= this.max || this.grid && this.grid.isColumn) d[b] || (d[b] = new I(this, b)), a && d[b].isNew && d[b].render(c, !0, -1), d[b].render(c) };
            a.prototype.render = function() {
                ...
                b.overlap = !1;
                [h, f, x].forEach(function(b) { D(b, function(b) { b.isActive = !1 }) });
                if (b.hasData() || e) {
                    var w = b.chart.hasRendered && b.old && g(b.old.min);
                    b.minorTickInterval && !b.categories && b.getMinorTickPositions().forEach(function(c) { b.renderMinorTick(c, w) });
                    k.length && (k.forEach(function(c, a) { b.renderTick(c, a, w) }), m && (0 === b.min || b.single) && (h[-1] || (h[-1] = new I(b, -1, null, !0)), h[-1].render(-1)));
                    n && k.forEach(function(d, g) {
                        P = "undefined" !== typeof k[g +
                            1] ? k[g + 1] + m : b.max - m;
                        0 === g % 2 && d < b.max && P <= b.max + (c.polar ? -m : m) && (x[d] || (x[d] = new H.PlotLineOrBand(b)), A = d + m, x[d].options = { from: a ? a.lin2log(A) : A, to: a ? a.lin2log(P) : P, color: n, className: "highcharts-alternate-grid" }, x[d].render(), x[d].isActive = !0)
                    });
                    b._addedPlotLB || (b._addedPlotLB = !0, (d.plotLines || []).concat(d.plotBands || []).forEach(function(c) { b.addPlotBandOrLine(c) }))
                }[h, f, x].forEach(function(b) {
                    var a = [],
                        d = K.duration;
                    D(b, function(b, c) { b.isActive || (b.render(c, !1, 0), b.isActive = !1, a.push(c)) });
                    W(function() {
                        for (var c =
            ...
            a.prototype.destroy = function(b) {
                ...
                b || Q(c);
                [c.ticks, c.minorTicks, c.alternateBands].forEach(function(b) { v(b) });
                if (a)
                ...
                D(c, function(b, a) {-1 === c.getKeepProps().indexOf(a) && delete c[a] });
                this.eventOptions = d
            };
            a.prototype.drawCrosshair = function(b, c) {
                ...
                if (a && !1 !== (n(c) || !d)) {
                    ...
                    if (!n(r)) { this.hideCrosshair(); return }
                    ...
                    k || (this.cross = k = g.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (d ? "category " : "thin ") + (a.className || "")).attr({ zIndex: K(a.zIndex, 2) }).add(), g.styledMode ||
                        (k.attr({ stroke: a.color || (d ? C.parse("#ccd6eb").setOpacity(.25).get() : "#cccccc"), "stroke-width": K(a.width, 1) }).css({ "pointer-events": "none" }), a.dashStyle && k.attr({ dashstyle: a.dashStyle })));
                    k.show().attr({ d: r });
            ...
            a.prototype.remove = function(b) {
                ...
                w(c.axes, this);
                w(c[a], this);
                c[a].forEach(function(b, c) { b.options.index = b.userOptions.index = c });
                this.destroy();
                c.isDirtyBox = !0;
                K(b, !0) && c.redraw()
            };
            a.prototype.setTitle = function(b, c) { this.update({ title: b }, c) };
            a.prototype.setCategories = function(b, c) { this.update({ categories: b }, c) };
    ...
    M(f, "Core/Axis/DateTimeAxis.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            ...
            function z(a) { "datetime" !== a.userOptions.type ? this.dateTime = void 0 : this.dateTime || (this.dateTime = new m(this)) }
            var p = [];
            a.compose = function(a) {-1 === p.indexOf(a) && (p.push(a), a.keepProps.push("dateTime"), a.prototype.getTimeTicks = B, f(a, "init", z)); return a };
            var m = function() {
                ...
                a.prototype.getXDateFormat = function(a, e) { var d = this.axis; return d.closestPointRange ? d.chart.time.getDateFormat(d.closestPointRange, a, d.options.startOfWeek, e) || e.year : e.day };
                return a
            }();
            a.Additions =
                m
    ...
    M(f, "Core/Axis/LogarithmicAxis.js", [f["Core/Utilities.js"]], function(a) {
        var f = a.addEvent,
            ...
            H;
        (function(a) {
            function B(a) { var d = this.logarithmic; "logarithmic" !== a.userOptions.type ? this.logarithmic = void 0 : d || (this.logarithmic = new m(this)) }

            function z() {
                var a = this.logarithmic;
                a && (this.lin2val = function(d) { return a.lin2log(d) }, this.val2lin = function(d) { return a.log2lin(d) })
            }
            var p = [];
            ...
            var m = function() {
                ...
                a.prototype.getLogTickPositions = function(a, e, h, f) {
                    ...
                    if (.5 <= a) a = Math.round(a), p = d.getLinearTickPositions(a, e, h);
                    else if (.08 <= a) {
                        var t = Math.floor(e),
                            q, k = m = void 0;
    ...
    M(f, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [f["Core/Utilities.js"]], function(a) {
        ...
        (function(a) {
            var u = [],
                B;
            a.compose = function(a, f) { B || (B = a); - 1 === u.indexOf(f) && (u.push(f), C(f.prototype, z.prototype)); return f };
            var z = function() {
                function a() {}
                a.prototype.getPlotBandPath = function(a, e, d) {
                    void 0 === d && (d = this.options);
                    var f = this.getPlotLinePath({ value: e, force: !0, acrossPanes: d.acrossPanes }),
                        h = [],
                        m = this.horiz;
                ...
                a.prototype.addPlotBandOrLine = function(a, e) {
                    ...
                    if (h) {
                        this._addedPlotLB || (this._addedPlotLB = !0, (f.plotLines || []).concat(f.plotBands || []).forEach(function(a) { d.addPlotBandOrLine(a) }));
                        if (e) {
                            var m = f[e] || [];
                            m.push(a);
                            f[e] = m
                ...
                a.prototype.removePlotBandOrLine = function(a) {
                    ...
                    if (e) {
                        ...
                        [d.plotLines || [], l.plotLines || [], d.plotBands || [], l.plotBands || []].forEach(function(d) { for (h = d.length; h--;)(d[h] || {}).id === a && f(d, d[h]) })
                    }
                };
    ...
    M(f, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [f["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], f["Core/Utilities.js"]], function(a, f) {
        ...
        f = function() {
            ...
            e.compose = function(d) { return a.compose(e, d) };
            e.prototype.render = function() {
                ...
                D = u(r);
                var P = !x,
                    Q = { "class": "highcharts-plot-" + (K ? "band " : "line ") + (n.className || "") },
                    O = K ? "bands" : "lines";
                ...
                if (D) D = e.getPlotLinePath({ value: r, lineWidth: x.strokeWidth(), acrossPanes: n.acrossPanes });
                else if (K) D = e.getPlotBandPath(b, g, n);
                else return;
                !a.eventsAdded && y && (p(y, function(b, c) { x.on(c, function(b) { y[c].apply(a, [b]) }) }), a.eventsAdded = !0);
                ...
                k && (u(k.text) || u(k.formatter)) && D && D.length && 0 < e.width && 0 < e.height && !D.isFlat ?
                    (k = z({ align: f && K && "center", x: f ? !K && 4 : 10, verticalAlign: !f && K && "middle", y: f ? K ? 16 : 10 : K ? 6 : -4, rotation: f && !K && 90 }, k), this.renderLabel(k, D, K, w)) : c && c.hide();
                return a
            };
            e.prototype.renderLabel = function(a, e, f, m) {
                var d = this.axis,
                    h = d.chart.renderer,
                    l = this.label;
                l || (this.label = l = h.text(this.getLabelText(a), 0, 0, a.useHTML).attr({ align: a.textAlign || a.align, rotation: a.rotation, "class": "highcharts-plot-" + (f ? "band" : "line") + "-label " + (a.className || ""), zIndex: m }).add(), d.chart.styledMode || l.css(z({ textOverflow: "ellipsis" },
                    a.style)));
            ...
            e.prototype.getLabelText = function(a) { return u(a.formatter) ? a.formatter.call(this) : a.text };
        ...
        a = function() {
            ...
            a.prototype.applyFilter = function() {
                ...
                c.renderer.definition({
                    ...
                    children: [{ tagName: "feGaussianBlur", attributes: { "in": "SourceAlpha", stdDeviation: 1 } }, { tagName: "feOffset", attributes: { dx: 1, dy: 1 } }, { tagName: "feComponentTransfer", children: [{ tagName: "feFuncA", attributes: { type: "linear", slope: .3 } }] },
                        { tagName: "feMerge", children: [{ tagName: "feMergeNode" }, { tagName: "feMergeNode", attributes: { "in": "SourceGraphic" } }] }
                    ]
                })
            };
            a.prototype.bodyFormatter = function(c) { return c.map(function(c) { var b = c.series.tooltipOptions; return (b[(c.point.formatPrefix || "point") + "Formatter"] || c.point.tooltipFormatter).call(c.point, b[(c.point.formatPrefix || "point") + "Format"] || "") }) };
            ...
            a.prototype.getLabel = function() {
                ...
                if (!this.label) {
                    if (this.outside) {
                        ...
                        m(n, { position: "absolute", top: "1px", pointerEvents: h, zIndex: Math.max(this.options.style.zIndex || 0, (t && t.zIndex || 0) + 3) });
                        z(n, "mouseenter", q);
                        z(n, "mouseleave", l);
                        f.doc.body.appendChild(n);
                        this.renderer = p = new A(n, 0, 0, t, void 0, void 0, p.styledMode)
                    }
                    d ? this.label = p.g(k) : (this.label = p.label("", 0, 0, b.shape, void 0, void 0, b.useHTML, void 0, k).attr({ padding: b.padding, r: b.borderRadius }), a || this.label.attr({ fill: b.backgroundColor, "stroke-width": b.borderWidth }).css(b.style).css({ pointerEvents: h }).shadow(b.shadow));
            ...
            a.prototype.getPosition = function(c, a, b) {
                var d = this.chart,
                    ...
                    m = function(e) { var k = "x" === e; return [e, k ? h : q, k ? c : a].concat(f ? [k ? c * l.scaleX : a * l.scaleY, k ? l.left - g + (b.plotX + d.plotLeft) * l.scaleX : l.top - g + (b.plotY + d.plotTop) * l.scaleY, 0, k ? h : q] : [k ? c : a, k ? b.plotX + d.plotLeft : b.plotY + d.plotTop, k ? d.plotLeft : d.plotTop, k ? d.plotLeft + d.plotWidth : d.plotTop + d.plotHeight]) },
                    n = m("y"),
                    p = m("x"),
                    t;
                m = !!b.negative;
                ...
                var A = !this.followPointer && y(b.ttBelow, !d.inverted === m),
                    ...
                    T = function() {!1 !== w.apply(0, n) ? !1 !== v.apply(0, p) || t || (E(!0), T()) : t ? e.x = e.y = 0 : (E(!0), T()) };
            ...
            a.prototype.move = function(c, a, b, d) {
                ...
                l(e, { x: k ? (2 * e.x + c) / 3 : c, y: k ? (e.y + a) / 2 : a, anchorX: r ? void 0 : k ? (2 * e.anchorX + b) / 3 : b, anchorY: r ? void 0 : k ? (e.anchorY + d) / 2 : d });
                g.getLabel().attr(e);
                g.drawTracker();
                k && (u.clearTimeout(this.tooltipTimeout), this.tooltipTimeout =
                    setTimeout(function() { g && g.move(c, a, b, d) }, 32))
            };
                ...
                if (d.enabled && e.series) {
                    ...
                    if (!1 === f) this.hide();
                        ...
                        if (this.split && this.allowShared) this.renderSplit(f, g);
                            ...
                            if (b.polar || !1 === q.options.clip || g.some(function(b) { return b.series.shouldShowTooltip(w, v) })) a = this.getLabel(), d.style.width && !l || a.css({
                                width: this.chart.spacingBox.width +
                                    "px"
                            }), a.attr({ text: f && f.join ? f.join("") : f }), a.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + y(e.colorIndex, q.colorIndex)), l || a.attr({ stroke: d.borderColor || e.color || q.color || "#666666" }), this.updatePosition({ plotX: n, plotY: p, negative: e.negative, ttBelow: e.ttBelow, h: c[2] || 0 });
            ...
            a.prototype.renderSplit = function(c, a) {
                ...
                var u = e.styledMode,
                    ...
                    N = d.outside && "number" !== typeof A ? I.documentElement.getBoundingClientRect() : { left: z, right: z + k, top: w, bottom: w + f },
                    U = d.getLabel(),
                ...
                c = c.slice(0, a.length + 1).reduce(function(c, g, e) {
                    if (!1 !== g && "" !== g) {
                        ...
                        "number" === typeof D ? (l = l.height + 1, n = T ? T.call(d, g, l, e) : b(x, D, k, g), c.push({ align: T ? 0 : void 0, anchorX: x, anchorY: D, boxWidth: g, point: e, rank: y(n.rank, k ? 1 : 0), size: l, target: n.y, tt: f, x: n.x })) : f.isActive = !1
                    }
                    return c
                }, []);
                !T && c.some(function(b) { var c = (d.outside ? S : 0) + b.anchorX; return c < N.left && c + b.boxWidth < N.right ? !0 : c < S - N.left + b.boxWidth && N.right - c > c }) && (c =
                    c.map(function(c) { var a = b(c.anchorX, c.anchorY, c.point.isHeader, c.boxWidth, !1); return l(c, { target: a.y, x: a.x }) }));
                d.cleanSplit();
                B(c, H);
                var G = S,
                    ba = S;
                ...
                c.forEach(function(b) {
                    var c = b.x,
                        ...
                        g = b.pos,
                        e = b.point.isHeader;
                    g = { visibility: "undefined" === typeof g ? "hidden" : "inherit", x: c, y: g + C, anchorX: a, anchorY: b.anchorY };
                    if (d.outside && c < a) {
                        var k = S - G;
            ...
            a.prototype.tooltipFooterHeaderFormatter = function(c, a) {
                ...
                h(this, "headerFormatter", g, function(a) {
                    ...
                    e && k && (c.point && c.point.tooltipDateKeys || ["key"]).forEach(function(b) { f = f.replace("{point." + b + "}", "{point." + b + ":" + k + "}") });
    ...
    M(f, "Core/Series/Point.js", [f["Core/Renderer/HTML/AST.js"], f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/FormatUtilities.js"], f["Core/Utilities.js"]], function(a, f, C, G, u) {
        ...
        f = function() {
            ...
            g.prototype.animateBeforeDestroy = function() {
                ...
                a.singular.forEach(function(a) { b[a] = b[a].animate("dataLabel" === a ? { x: b[a].startXPos, y: b[a].startYPos, opacity: 0 } : c) });
                a.plural.forEach(function(c) { b[c].forEach(function(c) { c.element && c.animate(e({ x: b.startXPos }, c.startYPos ? { x: c.startXPos, y: c.startYPos } : {})) }) })
            };
            ...
            g.prototype.destroy = function() {
                function b() { if (c.graphic || c.dataLabel || c.dataLabels) k(c), c.destroyElements(); for (f in c) c[f] = null }
                var c = this,
                    a = c.series,
                    d = a.chart;
            ...
            g.prototype.destroyElements =
                function(b) {
                    ...
                    b.singular.forEach(function(b) { c[b] = c[b].destroy() });
                    b.plural.forEach(function(b) {
                        c[b].forEach(function(b) { b.element && b.destroy() });
                        delete c[b]
                    })
                };
            g.prototype.firePointEvent = function(b, c, a) {
                ...
                "click" === b && e.allowPointSelect && (a = function(b) { g.select && g.select(null, b.ctrlKey || b.metaKey || b.shiftKey) });
                d(g, b, c, a)
            };
            ...
            g.prototype.getNestedProperty = function(b) { if (b) return 0 === b.indexOf("custom.") ? l(b, this.options) : this[b] };
            ...
            g.prototype.optionsToObject = function(b) {
                ...
                if (n(b) || null === b) k[d[0]] = b;
                    ...
                    for (!a && b.length > e && (c = typeof b[0], "string" === c ? k.name = b[0] : "number" === c && (k.x = b[0]), f++); q < e;) a && "undefined" === typeof b[f] || (0 < d[q].indexOf(".") ? g.prototype.setNestedProperty(k,
                        b[f], d[q]) : k[d[q]] = b[f]), f++, q++;
                else "object" === typeof b && (k = b, b.dataLabels && (c._hasPointLabels = !0), b.marker && (c._hasPointMarkers = !0));
                return k
            };
            ...
            g.prototype.setNestedProperty = function(b, c, a) { a.split(".").reduce(function(b, a, d, g) { b[a] = g.length - 1 === d ? c : v(b[a], !0) ? b[a] : {}; return b[a] }, b); return b };
            ...
            g.prototype.remove = function(b, c) { this.series.removePoint(this.series.data.indexOf(this), b, c) };
                ...
                if (!(b === this.state && !c || this.selected && "select" !== b || !1 === f.enabled || b && (l || q && !1 === r.enabled) || b && m.states &&
                    ...
                    if (this.graphic && !this.hasDummyGraphic) {
                        ...
                        if (!p.styledMode) {
                            ...
                            g.options.inactiveOtherPoints && n(z.opacity) && ((this.dataLabels || []).forEach(function(b) { b && b.animate({ opacity: z.opacity }, E) }), this.connector && this.connector.animate({ opacity: z.opacity },
                                E));
    ...
    M(f, "Core/Pointer.js", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Tooltip.js"], f["Core/Utilities.js"]], function(a, f, C, G) {
        ...
        a = function() {
            ...
            a.prototype.drag = function(a) {
                ...
                if (!v || !v.touch)
                    if (w < e ? w = e : w > e + h && (w = e + h), y < f ? y = f : y > f + q && (y = f + q), this.hasDragged = Math.sqrt(Math.pow(l - w, 2) + Math.pow(m - y, 2)), 10 < this.hasDragged) {
                        var A = d.isInsidePlot(l - e, m - f, { visiblePlotOnly: !0 });
                        !d.hasCartesianSeries && !d.mapView ||
                            !this.zoomX && !this.zoomY || !A || p || v || (this.selectionMarker = v = d.renderer.rect(e, f, g ? 1 : h, b ? 1 : q, 0).attr({ "class": "highcharts-selection-marker", zIndex: 7 }).add(), d.styledMode || v.attr({ fill: c.selectionMarkerFill || u("#335cad").setOpacity(.25).get() }));
            ...
            a.prototype.drop = function(a) {
                ...
                if (this.selectionMarker) {
                    var b = this.selectionMarker,
                        ...
                        w = { originalEvent: a, xAxis: [], yAxis: [], x: f, y: q, width: n, height: t },
                        y = !!c.mapView;
                    if (this.hasDragged || g) c.axes.forEach(function(b) {
                        if (b.zoomEnabled && m(b.min) && (g || d[{ xAxis: "zoomX", yAxis: "zoomY" }[b.coll]]) && h(f) && h(q)) {
                            var c =
                                b.horiz,
                    ...
                    }), y && l(c, "selection", w, function(b) { c.zoom(e(b, g ? { animation: !1 } : null)) });
            ...
            a.prototype.getChartCoordinatesFromPoint =
                function(a, d) {
                    ...
                    if (g && c) {
                        ...
                        return d ? { chartX: c.len + c.pos - k, chartY: g.len + g.pos - e } : { chartX: e + g.pos, chartY: k + c.pos }
                    }
            ...
            a.prototype.getCoordinates = function(a) {
                var d = { xAxis: [], yAxis: [] };
                this.chart.axes.forEach(function(c) { d[c.isXAxis ? "xAxis" : "yAxis"].push({ axis: c, value: c.toValue(a[c.horiz ? "chartX" : "chartY"]) }) });
                return d
            };
            a.prototype.getHoverData = function(a, e, c, g, b, f) {
                ...
                var q = e && !e.stickyTracking ? [e] : c.filter(function(a) { return h.filter ? h.filter(a) : a.visible && !(!b && a.directTouch) && w(a.options.enableMouseTracking, !0) && a.stickyTracking });
                var r = g || !f ? a : this.findNearestKDPoint(q, b, f);
                e = r && r.series;
                r && (b && !e.noSharedTooltip ? (q = c.filter(function(a) { return h.filter ? h.filter(a) : a.visible && !(!b && a.directTouch) && w(a.options.enableMouseTracking, !0) && !a.noSharedTooltip }), q.forEach(function(b) {
                        var a = d(b.points, function(b) { return b.x === r.x && !b.isNull });
            ...
            a.prototype.inClass = function(a, d) {
                for (var c; a;) {
                    if (c = z(a, "class")) { if (-1 !== c.indexOf(d)) return !0; if (-1 !== c.indexOf("highcharts-container")) return !1 }
                    a = a.parentElement
                }
            };
            ...
            a.prototype.pinch = function(a) {
                var d = this,
                    ...
                    q = d.hasZoom,
                    m = {},
                    n = 1 === f && (d.inClass(a.target,
                        "highcharts-tracker") && c.runTrackerClick || d.runChartClick),
                    p = {},
                    t = d.selectionMarker;
                1 < f ? d.initiated = !0 : 1 === f && this.followTouchMove && (d.initiated = !1);
                q && d.initiated && !n && !1 !== a.cancelable && a.preventDefault();
                [].map.call(b, function(b) { return d.normalize(b) });
                "touchstart" === a.type ? ([].forEach.call(b, function(b, a) { g[a] = { chartX: b.chartX, chartY: b.chartY } }), h.x = [g[0].chartX, g[1] && g[1].chartX], h.y = [g[0].chartY, g[1] && g[1].chartY], c.axes.forEach(function(b) {
                    if (b.zoomEnabled) {
            ...
            a.prototype.pinchTranslateDirection = function(a, d, c, g, b, e, f, h) {
                ...
                d();
                c = E;
                if (c < x.min) { c = x.min; var z = !0 } else c + y > x.max && (c = x.max - y, z = !0);
            ...
            a.prototype.reset = function(a, d) {
                ...
                }) : b && (b.setState(b.state, !0), c.axes.forEach(function(a) { a.crosshair && b.series[a.coll] === a && a.drawCrosshair(null, b) })));
                else {
                    if (b) b.onMouseOut();
                    e && e.forEach(function(b) { b.setState() });
                    if (g) g.onMouseOut();
                    f && f.hide(d);
                    this.unDocMouseMove && (this.unDocMouseMove = this.unDocMouseMove());
                    c.axes.forEach(function(b) { b.hideCrosshair() });
            ...
            a.prototype.runPointActions = function(e, f) {
                ...
                if (k && (k !== c.hoverPoint || g && g.isHidden)) {
                    (c.hoverPoints || []).forEach(function(b) {-1 === l.indexOf(b) && b.setState() });
                    ...
                    c.hoverPoints = l;
                    c.hoverPoint = k;
                    k.firePointEvent("mouseOver", void 0, function() { g && k && g.refresh(m ? l : k, e) })
                } else f &&
                    g && !g.isHidden && (b = g.getAnchor([{}], e), c.isInsidePlot(b[0], b[1], { visiblePlotOnly: !0 }) && g.updatePosition({ plotX: b[0], plotY: b[1] }));
                this.unDocMouseMove || (this.unDocMouseMove = B(c.container.ownerDocument, "mousemove", function(b) { var c = F[a.hoverChartIndex]; if (c) c.pointer.onDocumentMouseMove(b) }), this.eventsToUnbind.push(this.unDocMouseMove));
            ...
            a.prototype.setDOMEvents = function() {
                ...
                for (var g = this.chart.renderTo.parentElement; g && "BODY" !== g.tagName;) this.eventsToUnbind.push(B(g, "scroll", function() { delete d.chartPosition })), g =
                    g.parentElement;
            ...
            a.prototype.touch = function(a, d) {
                ...
                if (1 === a.touches.length)
                    if (a = this.normalize(a), (e = c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop, { visiblePlotOnly: !0 })) && !c.openMenu) {
                        d && this.runPointActions(a);
                        if ("touchmove" === a.type) { d = this.pinchDown; var b = d[0] ? 4 <= Math.sqrt(Math.pow(d[0].chartX - a.chartX, 2) + Math.pow(d[0].chartY - a.chartY, 2)) : !1 }
                        w(b, !0) && this.pinch(a)
                    } else d && this.reset();
    ...
    M(f, "Core/MSPointer.js", [f["Core/Globals.js"], f["Core/Pointer.js"], f["Core/Utilities.js"]],
        function(a, f, C) {
            function F() {
                ...
                d(h, function(d) { a.push({ pageX: d.pageX, pageY: d.pageY, target: d.target }) });
                return a
            }

            function u(a, d, e, h) { var l = I[f.hoverChartIndex || NaN]; "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !l || (l = l.pointer, h(a), l[d]({ type: e, target: a.currentTarget, preventDefault: z, touches: F() })) }
            var H = this && this.__extends || function() {
                    var a = function(d, e) {
                        ...
                        instanceof Array && function(a, d) {
                            a.__proto__ =
                                d
                        } || function(a, d) { for (var e in d) d.hasOwnProperty(e) && (a[e] = d[e]) };
                        return a(d, e)
                    };
                    return function(d, e) {
            ...
            return function(d) {
                ...
                H(f, d);
                f.isRequired = function() { return !(a.hasTouch || !p.PointerEvent && !p.MSPointerEvent) };
                ...
                f.prototype.onContainerPointerDown =
                    function(a) { u(a, "onContainerTouchStart", "touchstart", function(a) { h[a.pointerId] = { pageX: a.pageX, pageY: a.pageY, target: a.currentTarget } }) };
                ...
                f.prototype.onDocumentPointerUp = function(a) { u(a, "onDocumentTouchEnd", "touchend", function(a) { delete h[a.pointerId] }) };
    ...
    M(f, "Core/Legend/Legend.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Series/Point.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Utilities.js"]], function(a, f, C, G, u, H) {
        ...
        H = function() {
            ...
            a.prototype.positionItem = function(b) {
                ...
                var f = b.checkbox,
                    k = b.legendGroup;
                k && k.element && (d = { translateX: e ? c : this.legendWidth - c - 2 * d - 4, translateY: g }, e = function() { v(a, "afterPositionItem", { item: b }) }, h(k.translateY) ? k.animate(d, void 0, e) : (k.attr(d), e()));
                f && (f.x = c, f.y = g)
            };
                ...
                if (b) {
                    ...
                    this.allItems.forEach(function(e) {
                        ...
                        if (g) {
                            ...
                            l(g, { left: b.translateX + e.checkboxOffset + g.x - 20 + "px", top: f + "px", display: this.proximate || f > d - 6 && f < d + a - 6 ? "" : "none" })
                        }
                    }, this)
                }
            };
            ...
            a.prototype.adjustMargins = function(b, a) {
                var c = this.chart,
                    d = this.options,
                    e = this.getAlignment();
                e && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(g, f) { g.test(e) && !h(b[f]) && (c[p[f]] = Math.max(c[p[f]], c.legend[(f + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][f] * d[f % 2 ? "x" : "y"] + A(d.margin, 12) + a[f] + (c.titleOffset[f] || 0))) })
            };
            a.prototype.proximatePositions = function() {
                ...
                this.allItems.forEach(function(d) {
                    ...
                    if (d.yAxis) {
                        ...
                        d.points && (e = n(g ? d.points : d.points.slice(0).reverse(), function(b) { return w(b.plotY) }));
            ...
            a.prototype.render = function() {
                ...
                var h = b.spacingBox.width - 2 * d - c.x; - 1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) && (h /= 2);
                ...
                this.renderTitle();
                k(e, function(b, a) { return (b.options && b.options.legendIndex || 0) - (a.options && a.options.legendIndex || 0) });
                ...
                b.styledMode || f.attr({ stroke: c.borderColor, "stroke-width": c.borderWidth || 0, fill: c.backgroundColor || "none" }).shadow(c.shadow);
                if (0 < e && 0 < l) f[f.placed ? "animate" : "attr"](f.crisp.call({}, { x: 0, y: 0, width: e, height: l }, f.strokeWidth()));
                f[h ? "show" : "hide"]();
            ...
            a.prototype.handleOverflow = function(b) {
                ...
                b && 0 < g && b > g && !1 !== l.enabled ? (this.clipHeight = E = Math.max(g - 20 - this.titleHeight - k, 0), this.currentPage = A(this.currentPage, 1), this.fullHeight = b, p.forEach(function(b, a) {
                    ...
                    c !== y && (y = c)
                }), v || (v = a.clipRect = d.clipRect(0, k, 9999, 0), a.contentGroup.clip(v)), t(E), N || (this.nav = N = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, n, n).add(N), w("upTracker").on("click", function() { a.scroll(-1, m) }), this.pager = d.text("", 15, 10).addClass("highcharts-legend-navigation"), !c.styledMode && l.style && this.pager.css(l.style),
                    this.pager.add(N), this.down = d.symbol("triangle-down", 0, 0, n, n).add(N), w("downTracker").on("click", function() { a.scroll(1, m) })), a.scroll(0), b = g) : N && (t(), this.nav = N.destroy(), this.scrollGroup.attr({ translateY: 1 }), this.clipHeight = 0);
                return b
            };
            a.prototype.scroll = function(b, a) {
                ...
                0 < n && ("undefined" !== typeof a && B(a, e), this.nav.attr({
                    ...
                    visibility: "visible"
                }), [this.up, this.upTracker].forEach(function(b) { b.attr({ "class": 1 === n ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" }) }), l.attr({ text: n + "/" + f }), [this.down, this.downTracker].forEach(function(b) { b.attr({ x: 18 + this.pager.getBBox().width, "class": n === f ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" }) }, this), e.styledMode || (this.up.attr({ fill: 1 === n ? h.inactiveColor : h.activeColor }), this.upTracker.css({
                    cursor: 1 === n ? "default" : "pointer"
                }), this.down.attr({ fill: n === f ? h.inactiveColor : h.activeColor }), this.downTracker.css({ cursor: n === f ? "default" : "pointer" })), this.scrollOffset = -g[n - 1] + this.initialItemY, this.scrollGroup.animate({ translateY: this.scrollOffset }), this.currentPage = n, this.positionCheckboxes(), b = F(A(a, e.renderer.globalAnimation, !0)), c(function() { v(d, "afterScroll", { currentPage: n }) }, b.duration))
            };
            a.prototype.setItemEvents = function(b, a, c) {
                var d = this,
                    ...
                    h = function(a) { d.allItems.forEach(function(c) { b !== c && [c].concat(c.linkedSeries || []).forEach(function(b) { b.setState(a, !g) }) }) };
    ...
    M(f, "Core/Chart/Chart.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/FormatUtilities.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/Legend.js"], f["Core/MSPointer.js"], f["Core/DefaultOptions.js"], f["Core/Pointer.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGRenderer.js"],
        ...
        a = function() {
            ...
            a.prototype.getArgs = function(b, a, c) { U(b) || b.nodeName ? (this.renderTo = b, this.init(a, c)) : this.init(b, a) };
            a.prototype.init = function(a, c) {
                ...
                R(this, "init", { args: arguments }, function() {
                    var g = V(b, a),
                        f = g.chart;
                    X(g.plotOptions,
                        function(b, a) { N(b) && (b.tooltip = e[a] && V(e[a].tooltip) || void 0) });
            ...
            a.prototype.getSeriesOrderByLinks = function() { return this.series.concat().sort(function(b, a) { return b.linkedSeries.length || a.linkedSeries.length ? a.linkedSeries.length - b.linkedSeries.length : 0 }) };
            ...
            a.prototype.isInsidePlot = function(b, a, c) {
                ...
                }!c.ignoreY && b.isInsidePlot && (d = m && (d ? m.xAxis : m.yAxis) || { pos: f, len: Infinity }, c = c.paneCoordinates ? d.pos + a : f +
            ...
            a.prototype.redraw = function(b) {
                ...
                this.layOutTitles();
                for (b = c.length; b--;) { var n = c[b]; if (n.options.stacking || n.options.centerInCategory) { var q = !0; if (n.isDirty) { var E = !0; break } } }
                if (E)
                    for (b = c.length; b--;) n = c[b], n.options.stacking && (n.isDirty = !0);
                c.forEach(function(b) {
                ...
                this.getMargins();
                a.forEach(function(b) { b.isDirty && (l = !0) });
                a.forEach(function(b) {
                    var a = b.min + "," + b.max;
            ...
            a.prototype.getSelectedPoints =
                function() { return this.series.reduce(function(b, a) { a.getPointsCollection().forEach(function(a) { S(a.selectedStaging, a.selected) && b.push(a) }); return b }, []) };
            ...
            a.prototype.temporaryDisplay = function(b) {
                var a = this.renderTo;
                if (b)
                    for (; a && a.style;) a.hcOrigStyle && (O(a, a.hcOrigStyle), delete a.hcOrigStyle), a.hcOrigDetached && (q.body.removeChild(a), a.hcOrigDetached = !1), a = a.parentNode;
                else
                    for (; a && a.style;) {
                        q.body.contains(a) ||
                            a.parentNode || (a.hcOrigDetached = !0, q.body.appendChild(a));
                        if ("none" === ea(a, "display", !1) || a.hcOricDetached) a.hcOrigStyle = { display: a.style.display, height: a.style.height, overflow: a.style.overflow }, b = { display: "block", overflow: "hidden" }, a !== this.renderTo && (b.height = 0), O(a, b), a.offsetWidth || a.style.setProperty("display", "block", "important");
                        a = a.parentNode;
                        if (a === q.body) break
                    }
            };
            ...
            a.prototype.getAxisMargins = function() {
                ...
                k.forEach(function(c, e) { W(d[e]) || (b[c] += a[e]) });
                b.setChartSize()
            };
            a.prototype.reflow = function(b) {
                ...
                if (!e && !a.isPrinting && f && c && (d === g || d === q)) {
                    if (f !== a.containerWidth || c !==
                        a.containerHeight) l.clearTimeout(a.reflowTimeout), a.reflowTimeout = ba(function() { a.container && a.setSize(void 0, void 0, !1) }, b ? 100 : 0);
                    a.containerWidth = f;
                    a.containerHeight = c
                }
            };
            a.prototype.setReflow = function(b) { var a = this;!1 === b || this.unbindReflow ? !1 === b && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) : (this.unbindReflow = D(g, "resize", function(b) { a.options && a.reflow(b) }), D(this, "destroy", this.unbindReflow)) };
            a.prototype.setSize = function(b, a, c) {
                ...
                R(d,
                    "resize");
                ba(function() { d && R(d, "endResize", null, function() {--d.isResizing }) }, n(c).duration)
            };
            a.prototype.setChartSize = function(b) {
                ...
                this.clipBox = { x: d, y: e, width: Math.floor(this.plotSizeX - Math.max(a, k[1]) / 2 - d), height: Math.max(0, Math.floor(this.plotSizeY - Math.max(a, k[2]) / 2 - e)) };
            ...
            a.prototype.resetMargins = function() {
                ...
                ["margin", "spacing"].forEach(function(c) {
                    var d = a[c],
                        e = N(d) ? d : [d, d, d, d];
                    ["Top", "Right", "Bottom", "Left"].forEach(function(d, g) { b[c][g] = S(a[c + d], e[g]) })
                });
                k.forEach(function(a, c) { b[a] = S(b.margin[c], b.spacing[c]) });
            ...
            a.prototype.addCredits = function(b) {
                ...
                c.enabled && !this.credits && (this.credits = this.renderer.text(c.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function() { c.href && (g.location.href = c.href) }).attr({ align: c.position.align, zIndex: 8 }), a.styledMode ||
            ...
            a.prototype.firstRender = function() {
                ...
                if (!b.isReadyToRender || b.isReadyToRender()) {
                    ...
                    b.propFromSeries();
                    b.getAxes();
                    (E(a.series) ? a.series : []).forEach(function(a) { b.initSeries(a) });
                    b.linkSeries();
                    b.setSeriesData();
                    R(b, "beforeRender");
            ...
            a.prototype.showLoading = function(b) {
                var a = this,
                    c = a.options,
                    d = c.loading,
                    e = function() { g && O(g, { left: a.plotLeft + "px", top: a.plotTop + "px", width: a.plotWidth + "px", height: a.plotHeight + "px" }) },
                    g = a.loadingDiv,
                    f = a.loadingSpan;
                ...
                a.styledMode || (O(g, M(d.style, { zIndex: 10 })), O(f, d.labelStyle), a.loadingShown || (O(g, { opacity: 0, display: "" }), t(g, { opacity: d.style.opacity || .5 }, { duration: d.showDuration || 0 })));
                a.loadingShown = !0;
                e()
            };
            a.prototype.hideLoading = function() {
                ...
                a && (a.className = "highcharts-loading highcharts-loading-hidden", this.styledMode ||
                    t(a, { opacity: 0 }, { duration: b.loading.hideDuration || 100, complete: function() { O(a, { display: "none" }) } }));
                this.loadingShown = !1
            };
            a.prototype.update = function(b, a, c, e) {
                ...
                if (n) {
                    ...
                    if ("inverted" in n || "polar" in n || "type" in n) { g.propFromSeries(); var q = !0 }
                    "alignTicks" in n && (q = !0);
                    "events" in n && y(this, n);
                    X(n, function(b, a) {-1 !== g.propsRequireUpdateSeries.indexOf("chart." + a) && (l = !0); - 1 !== g.propsRequireDirtyBox.indexOf(a) && (g.isDirtyBox = !0); - 1 !== g.propsRequireReflow.indexOf(a) && (k ? g.isDirtyBox = !0 : m = !0) });
                ...
                X(b, function(a, c) {
                    ...
                    else "colors" !== c && -1 === g.collectionsWithUpdate.indexOf(c) && V(!0, g.options[c], b[c]);
                    "chart" !== c && -1 !== g.propsRequireUpdateSeries.indexOf(c) && (l = !0)
                });
                this.collectionsWithUpdate.forEach(function(a) {
                    if (b[a]) {
                        var d = [];
                        g[a].forEach(function(b, a) { b.options.isInternal || d.push(S(b.options.index, a)) });
                        ...
                        c && g[a].forEach(function(b) { b.touched || b.options.isInternal ? delete b.touched : h.push(b) })
                    }
                });
                h.forEach(function(b) { b.chart && b.remove && b.remove(!1) });
                q && g.axes.forEach(function(b) { b.update({}, !1) });
            ...
            a.prototype.showResetZoom = function() {
                ...
                R(this, "beforeShowResetZoom", null, function() { c.resetZoomButton = c.renderer.button(d.resetZoom, null, null, a, g, f && f.hover).attr({ align: e.position.align, title: d.resetZoomTitle }).addClass("highcharts-reset-zoom").add().align(e.position, !1, k) });
            ...
            a.prototype.zoom =
                function(b) {
                    var a = this,
                        ...
                        e = !1,
                        g;
                    !b || b.resetSelection ? (a.axes.forEach(function(b) { g = b.zoom() }), c.initiated = !1) : b.xAxis.concat(b.yAxis).forEach(function(b) {
                        var f = b.axis,
                ...
                R(this, "pan", { originalEvent: b }, function() {
                    ...
                    a.forEach(function(a) {
                        if (a.options.panningEnabled && !a.options.isInternal) {
                            ...
                            a.panningState = t;
                            a.isOrdinal || (n = m - l, 0 < n && (E += n, l = m), n = E - r, 0 < n && (E = r, l -= n), a.series.length && l !== q.min && E !== q.max && l >= m && E <= r && (a.setExtremes(l, E, !1, !1, { trigger: "pan" }), c.resetZoomButton || g || l === m || E === r || !f.match("y") || (c.showResetZoom(), a.displayBtn = !1), k = !0), e[d] = h)
                        }
                    });
                    X(e, function(b, a) { c[a] = b });
                    k && c.redraw(!1);
        ...
        (function(a) {
            a.drawLineMarker = function(a) {
                ...
                this.legendLine = m.path([
                    ["M", 0, a],
                    ["L", B, a]
                ]).addClass("highcharts-graph").attr(d).add(e);
                l && !1 !== l.enabled && B && (u = Math.min(C(l.radius, p), p), 0 === this.symbol.indexOf("url") && (l = f(l, { width: z, height: z }), u = 0), this.legendSymbol = B = m.symbol(this.symbol, B / 2 - u, a - u, 2 * u, 2 * u, l).addClass("highcharts-point").add(e), B.isMarker = !0)
            };
            a.drawRectangle =
                function(a, f) {
    ...
    M(f, "Core/Series/Series.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Point.js"], f["Core/Series/SeriesDefaults.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"],
        ...
        a = function() {
            ...
            a.prototype.init = function(a, b) {
                ...
                c.getColor();
                c.getSymbol();
                c.parallelArrays.forEach(function(a) { c[a + "Data"] || (c[a + "Data"] = []) });
            ...
            a.prototype.setOptions = function(a) {
                ...
                !f.negativeColor && !f.negativeFillColor || f.zones || (c = { value: f[this.zoneAxis + "Threshold"] || f.threshold || 0, className: "highcharts-negative" }, b || (c.color = f.negativeColor, c.fillColor = f.negativeFillColor), e.push(c));
                e.length && g(e[e.length - 1].value) && e.push(b ? {} : { color: this.color, fillColor: this.fillColor });
                K(this, "afterSetOptions", { options: f });
                return f
            };
            a.prototype.getName = function() { return J(this.options.name, "Series " + (this.index + 1)) };
            ...
            a.prototype.getColor = function() { this.chart.styledMode ? this.getCyclic("color") : this.options.colorByPoint ? this.color = "#cccccc" : this.getCyclic("color", this.options.color || d.plotOptions[this.type].color, this.chart.options.colors) };
            ...
            a.prototype.findPointIndex = function(a, b) {
                ...
                if (c) g = this.chart.get(c), g instanceof H && (f = g);
                    ...
                    if (f = function(b) { return !b.touched && b.index === a.index }, g && g.matchByName ? f = function(b) { return !b.touched && b.name === a.name } : this.options.relativeXValue &&
                        (f = function(b) { return !b.touched && b.options.x === a.x }), f = D(e, f), !f) return;
                if (f) { var h = f && f.index; "undefined" !== typeof h && (k = !0) }
                "undefined" === typeof h && O(d) && (h = this.xData.indexOf(d, b)); - 1 !== h && "undefined" !== typeof h && this.cropped && (h = h >= this.cropStart ? h - this.cropStart : h);
            ...
            a.prototype.updateData = function(a, b) {
                ...
                a.forEach(function(a,
                    b) {
                    var n = g(a) && this.pointClass.prototype.optionsToObject.call({ series: this }, a) || {},
                        q = n.x;
                    if (n.id || O(q)) { if (n = this.findPointIndex(n, m), -1 === n || "undefined" === typeof n ? f.push(a) : e[n] && a !== c.data[n] ? (e[n].update(a, !1, null, !1), e[n].touched = !0, k && (m = n + 1)) : e[n] && (e[n].touched = !0), !h || b !== n || d && d.enabled || this.hasDerivedData) l = !0 } else f.push(a)
                }, this);
                if (l)
                    for (a = e.length; a--;)(n = e[a]) && !n.touched && n.remove && n.remove(!1, b);
                ...
                if (!w) {
                    ...
                    if (m && x > m)
                        if (A = e.getFirstValidPoint(a), O(A))
                            for (c = 0; c < x; c++) q[c] = this.autoIncrement(), p[c] = a[c];
                        else if (Q(A))
                        if (E)
                            if (A.length === E)
                                for (c = 0; c < x; c++) q[c] = this.autoIncrement(), p[c] = a[c];
                            else
                                for (c = 0; c < x; c++) d = a[c], q[c] = d[0], p[c] = d.slice(1,
                                    E + 1);
                    else if (t && (y = t.indexOf("x"), v = t.indexOf("y"), y = 0 <= y ? y : 0, v = 0 <= v ? v : 1), 1 === A.length && (v = 0), y === v)
                        for (c = 0; c < x; c++) q[c] = this.autoIncrement(), p[c] = a[c][v];
                    else
                        for (c = 0; c < x; c++) d = a[c], q[c] = d[y], p[c] = d[v];
                    else r(12, !1, h);
                    else
                        for (c = 0; c < x; c++) "undefined" !== typeof a[c] && (d = { series: e }, e.pointClass.prototype.applyOptions.apply(d, [a[c]]), e.updateParallelArrays(d, c));
                    p && W(p[0]) && r(14, !0, h);
                    e.data = [];
            ...
            a.prototype.sortData = function(a) {
                var b = this,
                    ...
                    d = function(a, b) { return g(b) && a.pointClass.prototype.optionsToObject.call({ series: a }, b) || {} };
            ...
            a.prototype.getProcessedData = function(a) {
                ...
                for (d = k.length || 1; --d;)
                    if (b = c ? a(k[d]) - a(k[d - 1]) : k[d] - k[d - 1], 0 < b && ("undefined" === typeof t || b < t)) var t = b;
            ...
            a.prototype.cropData = function(a, b, c, d, e) {
                ...
                for (f = 0; f < g; f++)
                    if (a[f] >= c) { k = Math.max(0, f - e); break }
                for (c = f; c < g; c++)
                    if (a[c] > d) { h = c + e; break }
                return {
                    xData: a.slice(k, h),
                    yData: b.slice(k,
                        h),
            ...
            a.prototype.generatePoints = function() {
                ...
                this.options.keys = h;
                if (q && (g !== (n = q.length) || k))
                    for (m = 0; m < n; m++) m !== f || k || (m += g), q[m] && (q[m].destroyElements(), q[m].plotX = void 0);
                this.data = q;
                this.points = l;
                K(this, "afterGeneratePoints")
            };
            a.prototype.getXExtremes = function(a) { return { min: A(a), max: y(a) } };
            ...
            a.prototype.getFirstValidPoint = function(a) { for (var b = a.length, c = 0, d = null; null === d && c < b;) d = a[c], c++; return d };
            a.prototype.translate = function() {
                ...
                for (w = 0; w < l; w++) {
                    ...
                    if (!A.isNull && !1 !== A.visible) { "undefined" !== typeof G && (v = Math.min(v, Math.abs(y - G))); var G = y }
            ...
            a.prototype.getValidPoints = function(a, b, c) {
                var d = this.chart;
                return (a || this.points || []).filter(function(a) { return b && !d.isInsidePlot(a.plotX, a.plotY, { inverted: d.inverted }) ? !1 : !1 !== a.visible && (c || !a.isNull) })
            };
            ...
            a.prototype.animate = function(a) {
                ...
                if (a && c) g = this.getClipBox(), k ? k.attr("height", g.height) : (g.width = 0, e && (g.x = b.plotHeight), k = b.renderer.clipRect(g),
                    b.sharedClips[f] = k, h = b.renderer.clipRect({ x: e ? (b.plotSizeX || 0) + 99 : -99, y: e ? -b.plotLeft : -b.plotTop, width: 99, height: e ? b.chartWidth : b.chartHeight }), b.sharedClips[f + "m"] = h), c.clip(k), d && d.clip(h);
            ...
            a.prototype.afterAnimate = function() {
                var a = this;
                this.setClip();
                L(this.chart.sharedClips, function(b, c, d) { b && !a.chart.container.querySelector('[clip-path="url(#' + b.id + ')"]') && (b.destroy(), delete d[c]) });
            ...
            a.prototype.destroy = function(a) {
                ...
                for (k = g.length; k--;)(h = g[k]) &&
                    h.destroy && h.destroy();
                c.clips && c.clips.forEach(function(a) { return a.destroy() });
                p.clearTimeout(c.animationTimeout);
                L(c, function(a, b) { a instanceof z && !a.survive && (f = e && "group" === b ? "hide" : "destroy", a[f]()) });
                d.hoverSeries === c && (d.hoverSeries = void 0);
                b(d.series, c);
                d.orderSeries();
                L(c, function(b, d) { a && "hcEvents" === d || delete c[d] })
            };
            a.prototype.applyZones = function() {
                ...
                if (d.length && (g || f) && h && "undefined" !== typeof h.min) {
                    ...
                    d.forEach(function(d, E) {
                        ...
                        t = Math.min(n, m);
                        w = Math.max(n, m);
                        h.isXAxis ? (r = { x: l ? w : t, y: 0, width: p, height: k }, D || (r.x = b.plotHeight - r.x)) : (r = {
                            x: 0,
                            y: l ? w : t,
                            width: k,
                            height: p
                        }, D && (r.y = b.plotWidth - r.y));
                        l && c.isVML && (r = h.isXAxis ? { x: 0, y: x ? t : w, height: r.width, width: b.chartWidth } : { x: r.y - b.plotLeft - b.spacingBox.x, y: 0, width: r.height, height: b.chartHeight });
            ...
            a.prototype.invertGroups = function(a) {
                function b() {
                    ["group", "markerGroup"].forEach(function(b) {
                        c[b] &&
                            (d.renderer.isVML && c[b].attr({ width: c.yAxis.len, height: c.xAxis.len }), c[b].width = c.yAxis.len, c[b].height = c.xAxis.len, c[b].invert(c.isRadialSeries ? !1 : a))
                    })
                }
                var c = this,
                    d = c.chart;
            ...
            a.prototype.render = function() {
                ...
                f || (b && d.defer && (b += d.defer), a.animationTimeout = R(function() { a.afterAnimate() }, b || 0));
                a.isDirty = !1;
                a.hasRendered = !0;
                K(a, "afterRender")
            };
            a.prototype.redraw = function() {
                var a = this.chart,
                    ...
                    d = this.xAxis,
                    e = this.yAxis;
                c && (a.inverted && c.attr({ width: a.plotWidth, height: a.plotHeight }), c.animate({ translateX: J(d && d.left, a.plotLeft), translateY: J(e && e.top, a.plotTop) }));
                this.translate();
                this.render();
            ...
            a.prototype.drawTracker = function() {
                var a = this,
                    ...
                    l = a.tracker,
                    n = function(b) { if (e.hoverSeries !== a) a.onMouseOver() },
                    m = "rgba(192,192,192," + (t ? .0001 : .002) + ")";
                l ? l.attr({ d: d }) : a.graph && (a.tracker = f.path(d).attr({ visibility: a.visible ? "visible" : "hidden", zIndex: 2 }).addClass(c ? "highcharts-tracker-area" : "highcharts-tracker-line").add(a.group), e.styledMode || a.tracker.attr({
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
                    stroke: m,
                    fill: c ? m : "none",
                    "stroke-width": a.graph.strokeWidth() + (c ? 0 : 2 * k)
                }), [a.tracker, a.markerGroup, a.dataLabelsGroup].forEach(function(a) { if (a && (a.addClass("highcharts-tracker").on("mouseover", n).on("mouseout", function(a) { g.onTrackerMouseOut(a) }), b.cursor && !e.styledMode && a.css({ cursor: b.cursor }), h)) a.on("touchstart", n) }));
            ...
            a.prototype.update = function(a, b) {
                ...
                var c = this,
                    ...
                    n = {},
                    m, q = ["eventOptions", "navigatorSeries", "baseSeries"],
                ...
                t && (q.push("data", "isDirtyData", "points", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "clips", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY",
                    "minX", "maxX"), !1 !== a.visible && q.push("area", "graph"), c.parallelArrays.forEach(function(a) { q.push(a + "Data") }), a.data && (a.dataSorting && x(c.options.dataSorting, a.dataSorting), this.setData(a.data, !1)));
                a = Z(e, l, { index: "undefined" === typeof e.index ? c.index : e.index, pointStart: J(f && f.series && f.series.pointStart, e.pointStart, c.xData[0]) }, !t && { data: c.options.data }, a);
                ...
                if (v[p]) {
                    if (f = p !== c.type, c.remove(!1, !1, !1, !0), f)
                        if (Object.setPrototypeOf) Object.setPrototypeOf(c, v[p].prototype);
                        else {
                ...
                if (t && this.points) {
                    ...
                    this.points.forEach(function(a) { a && a.series && (a.resolveColor(), Object.keys(n).length && a.destroyElements(n), !1 === w.showInLegend && a.legendItem && d.legend.destroyItem(a)) }, this)
                }
                c.initialType = g;
                d.linkSeries();
            ...
            a.prototype.setState = function(a, b) {
                ...
                if (c.state !== a && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function(b) {
                    ...
                    if (e && !e.dashstyle)
                        for (d = { "stroke-width": h }, e.animate(d, k); c["zone-graph-" + l];) c["zone-graph-" + l].animate(d, k), l += 1;
                    g || [c.group, c.markerGroup, c.dataLabelsGroup, c.labelBySeries].forEach(function(a) { a && a.animate({ opacity: n }, k) })
                }
            ...
            a.prototype.setVisible = function(a, b) {
                ...
                ["group", "dataLabelsGroup", "markerGroup", "tracker", "tt"].forEach(function(a) { if (c[a]) c[a][k]() });
        ...
        x(a.prototype, { axisTypes: ["xAxis", "yAxis"], coll: "series", colorCounter: 0, cropShoulder: 1, directTouch: !1, drawLegendSymbol: u.drawLineMarker, isCartesian: !0, kdAxisArray: ["clientX", "plotY"], parallelArrays: ["x", "y"], pointClass: H, requireSorting: !0, sorted: !0 });
        B.series = a;
        "";
        "";
        return a
    ...
    M(f, "Extensions/ScrollablePlotArea.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"], f["Core/Series/Series.js"],
        ...
        B(C, "render", function() { this.scrollablePixelsX || this.scrollablePixelsY ? (this.setUpScrolling && this.setUpScrolling(), this.applyFixed()) : this.fixedDiv && this.applyFixed() });
        C.prototype.setUpScrolling = function() {
            ...
            this.scrollingParent = z("div", { className: "highcharts-scrolling-parent" }, { position: "relative" }, this.renderTo);
        ...
        B(f, "afterInit", function() { this.chart.scrollableDirty = !0 });
        B(G, "show", function() { this.chart.scrollableDirty = !0 });
        ""
    });
    M(f, "Core/Axis/StackingAxis.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Utilities.js"]], function(a, f, C) {
        ...
        (function(a) {
            ...
            function d() { this.stacking || (this.stacking = new h(this)) }
            var f = [];
            a.compose = function(a) {-1 === f.indexOf(a) && (f.push(a), u(a, "init", d), u(a, "destroy", e)); return a };
            var h = function() {
                function a(a) {
                    this.oldStacks = {};
                    this.stacks = {};
                ...
                a.prototype.cleanStacks = function() {
                    if (!this.axis.isXAxis) {
                        ...
                        z(a, function(a) { z(a, function(a) { a.cumulative = a.total }) })
                    }
                };
                a.prototype.resetStacks = function() {
                    ...
                    a.axis.isXAxis || z(d, function(d) {
                        z(d,
                            function(e, f) { B(e.touched) && e.touched < a.stacksTouched ? (e.destroy(), delete d[f]) : (e.total = null, e.cumulative = null) })
                    })
                };
                a.prototype.renderStackTotals = function() {
                    ...
                    var h = this.stackTotalGroup = this.stackTotalGroup || e.g("stack-labels").attr({ visibility: "visible", zIndex: 6, opacity: 0 }).add();
                    h.translate(d.plotLeft, d.plotTop);
                    z(f, function(a) { z(a, function(a) { a.render(h) }) });
                    h.animate({ opacity: 1 },
                        a)
                };
                return a
    ...
    M(f, "Extensions/Stacking.js", [f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"], f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Series/Series.js"], f["Core/Axis/StackingAxis.js"], f["Core/Utilities.js"]], function(a, f, C, G, u, H, I) {
        var B = C.format,
            ...
            t = function() {
                function a(a, d, e, f, h) {
                    ...
                    this.alignOptions = { align: d.align || (k ? e ? "left" : "right" : "center"), verticalAlign: d.verticalAlign || (k ? "middle" : e ? "bottom" : "top"), y: d.y, x: d.x };
                    this.textAlign = d.textAlign || (k ? e ? "right" : "left" : "center")
                }
                a.prototype.destroy = function() { m(this, this.axis) };
                ...
                a.prototype.getStackBox = function(a, d, e, f, h, k, c) {
                    ...
                    return { x: b ? d ? f - c.right : f - k + c.pos - a.plotLeft : e + a.xAxis[0].transB - a.plotLeft, y: b ? c.height - e - h : d ? l - f - k : l - f, width: b ? k : h, height: b ? h : k }
                };
                return a
            }();
        ...
        u.prototype.setGroupedPoints = function() {
            ...
            this.options.centerInCategory && (this.is("column") || this.is("columnrange")) && !this.options.stacking && 1 < this.chart.series.length ? u.prototype.setStackedPoints.call(this, "group") : a && l(a.stacks, function(d, e) { "group" === e.slice(-5) && (l(d, function(a) { return a.destroy() }), delete a.stacks[e]) })
        };
        ...
        C = function(f) {
            ...
            B.prototype.drawGraph = function() {
                ...
                d.forEach(function(d, h) {
                    ...
                    n && !e && (l = { stroke: d[2], "stroke-width": f.lineWidth, fill: a.fillGraph && a.color || "none" }, d[3] ? l.dashstyle = d[3] : "square" !== f.linecap && (l["stroke-linecap"] = l["stroke-linejoin"] = "round"), n[p](l).shadow(2 > h && f.shadow));
            ...
            B.prototype.getGraphPath = function(a, f, m) {
                ...
                a.forEach(function(t, y) {
                    ...
                    t.isNull && !u(f) && 0 < y ? p = !d.connectNulls : t.isNull && !f ? p = !0 : (0 === y || p ? y = [
                        ["M", t.plotX, t.plotY]
                    ] : e.getPointSpline ? y = [e.getPointSpline(a, t, y)] : n ? (y = 1 === n ? [
                        ["L", k.plotX, q]
                    ] : 2 === n ? [
                    ...
                    ], h.push(t.x), n && (h.push(t.x), 2 === n && h.push(t.x)), l.push.apply(l, y), p = !1)
                });
                l.xMap = h;
    ...
    M(f, "Series/Area/AreaSeries.js", [f["Core/Color/Color.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, C, G) {
        var u = this && this.__extends || function() {
                var a = function(e, d) {
                    a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, d) { a.__proto__ = d } || function(a, d) { for (var e in d) d.hasOwnProperty(e) && (a[e] = d[e]) };
                    return a(e, d)
                };
                return function(e, d) {
        ...
        G = function(a) {
            ...
            e.prototype.getGraphPath = function(a) {
                ...
                var g = function(b, d, e) {
                    ...
                    "undefined" !== typeof l && (y.push({ plotX: r, plotY: null === l ? c : m.getThreshold(l), isNull: g, isCliff: !0 }), w.push({ plotX: r, plotY: null === n ? c : m.getThreshold(n), doCurve: !1 }))
                };
                a = a || this.points;
                f && (a = this.getStackPoints(a));
                for (v = 0; v < a.length; v++) { f || (a[v].leftCliff = a[v].rightCliff = a[v].leftNull = a[v].rightNull = void 0); var b = a[v].isNull; var r = p(a[v].rectPlotX, a[v].plotX); var x = f ? p(a[v].yBottom, c) : c; if (!b || e) e || g(v, v - 1, "left"), b && !f && e || (y.push(a[v]), w.push({ x: v, plotX: r, plotY: x })), e || g(v, v + 1, "right") }
                v = d.call(this, y, !0, !0);
                w.reversed = !0;
                b = d.call(this, w, !0, !0);
            ...
            e.prototype.getStackPoints = function(a) {
                ...
                if (this.options.stacking) {
                    ...
                    z(w, function(a, b) { null !== a.total && f.push(b) });
                    f.sort(function(a, b) { return a - b });
                    var b = A.map(function(a) { return a.visible });
                    f.forEach(function(a, g) {
                        ...
                        if (y[a] && !y[a].isNull) e.push(y[a]), [-1, 1].forEach(function(e) {
                            ...
                            for (var r = c; 0 <= r && r < q;) {
                                if (l = w[a].points[A[r].index]) { h = l[1]; break }
                                r += k
                            }
                            h = p(h, 0);
    ...
    M(f, "Series/AreaSpline/AreaSplineSeries.js", [f["Series/Area/AreaSeries.js"], f["Series/Spline/SplineSeries.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, C, G, u) {
        var F = this && this.__extends || function() {
                var a = function(f, e) {
                    a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, e) { a.__proto__ = e } || function(a, e) { for (var d in e) e.hasOwnProperty(d) && (a[d] = e[d]) };
                    return a(f, e)
                };
                return function(f, e) {
                    function d() { this.constructor = f }
    ...
    M(f,
        "Series/Column/ColumnSeries.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]],
        function(a, f, C, G, u, H, I) {
            ...
            I = function(a) {
                ...
                f.prototype.animate = function(a) {
                    ...
                    if (a) k.scaleY = .001, a = e(b.toPixels(d.threshold), b.pos, b.pos + b.len), f ? k.translateX = a - b.len : k.translateY = a, c.clipBox && c.setClip(), c.group.attr(k);
                    else {
                        var m = Number(c.group.attr(l));
                        c.group.animate({ scaleY: 1 }, h(z(c.options.animation), { step: function(a, d) { c.group && (k[l] = m + d.pos * (b.pos - m), c.group.attr(k)) } }))
                    }
                };
                ...
                f.prototype.getColumnMetrics = function() {
                    ...
                    !1 === d.grouping ? l = 1 : a.chart.series.forEach(function(b) {
                        ...
                        if (b.type === a.type && (b.visible || !a.chart.options.chart.ignoreHiddenSeries) && e.len === c.len && e.pos === c.pos) {
                            if (d.stacking && "group" !== d.stacking) { h = b.stackKey; "undefined" === typeof k[h] && (k[h] = l++); var f = k[h] } else !1 !== d.grouping && (f = l++);
                            b.columnIndex =
                                f
                        }
                    });
                    ...
                    a.columnMetrics = { width: d, offset: (q - d) / 2 + (n + ((a.columnIndex || 0) + (f ? 1 : 0)) * q - m / 2) * (f ? -1 : 1), paddedWidth: q, columnCount: l };
            ...
            h(I.prototype, { cropShoulder: 0, directTouch: !0, drawLegendSymbol: G.drawRectangle, getSymbol: a, negStacks: !0, trackerGroups: ["group", "dataLabelsGroup"] });
        ...
        (function(a) {
            function f(a, c, d, b, f) {
                var g = this,
                    ...
                    A = function(b) { l && g.xAxis && !y && g.setDataLabelStartPos(a, c, f, t, b) },
                    y = "justify" === e(d.overflow, l ? "none" : "justify"),
                    w = this.visible && !1 !== a.visible && (a.series.forceDL || l && !y || t || e(d.inside, !!this.options.stacking) && b && k.isInsidePlot(m, h ? b.x + 1 : b.y + b.height - 1, { inverted: h, paneCoordinates: !0, series: g }));
                if (w) {
                    var v = k.renderer.fontMetrics(k.styledMode ? void 0 : d.style.fontSize, c).b;
                    b = I({ x: h ? this.yAxis.len - n : m, y: Math.round(h ? this.xAxis.len - m : n), width: 0, height: 0 }, b);
                    I(d, {
                        width: q.width,
                        height: q.height
                    });
                    p ? (y = !1, m = k.renderer.rotCorr(v, p), m = { x: b.x + (d.x || 0) + b.width / 2 + m.x, y: b.y + (d.y || 0) + { top: 0, middle: .5, bottom: 1 }[d.verticalAlign] * b.height }, A(m), c[f ? "attr" : "animate"](m).attr({ align: r }), A = (p + 720) % 360, A = 180 < A && 360 > A, "left" === r ? m.y -= A ? q.height : 0 : "center" === r ? (m.x -= q.width / 2, m.y -= q.height / 2) : "right" === r && (m.x -= q.width, m.y -= A ? 0 : q.height), c.placed = !0, c.alignAttr = m) : (A(b), c.align(d, void 0, b), m = c.alignAttr);
                    y && 0 <= b.height ? this.justifyDataLabel(c, d, m, q, b, f) : e(d.crop, !0) && (w = k.isInsidePlot(m.x,
                        m.y, { paneCoordinates: !0, series: g }) && k.isInsidePlot(m.x + q.width, m.y + q.height, { paneCoordinates: !0, series: g }));
                    if (d.shape && !p) c[f ? "attr" : "animate"]({ anchorX: h ? k.plotWidth - a.plotY : a.plotX, anchorY: h ? k.plotHeight - a.plotX : a.plotY })
                }
                f && l && (c.placed = !1);
                w || l && !y || (c.hide(!0), c.placed = !1)
            }

            function h(a, c) { var d = c.filter; return d ? (c = d.operator, a = a[d.property], d = d.value, ">" === c && a > d || "<" === c && a < d || ">=" === c && a >= d || "<=" === c && a <= d || "==" === c && a == d || "===" === c && a === d ? !0 : !1) : !0 }
                    ...
                    b.forEach(function(b) {
                        ...
                        p.forEach(function(d, g) {
                            ...
                            if (k) {
                                ...
                                m(w, function(a, b) { "undefined" === typeof a && delete w[b] })
                            }!q || k && H(t) && !!q.div ===
            ...
            function w(a, c, d, b, e, f) {
                ...
                q = void 0 === q ? 0 : q;
                var n = (d.x || 0) + l;
                if (0 > n) { "right" === h && 0 <= m ? (c.align = "left", c.inside = !0) : m -= n; var p = !0 }
                n = (d.x || 0) + b.width - l;
            ...
            function y(a, c) {
                var d = [],
                    b;
                if (z(a) && !z(c)) d = a.map(function(a) { return p(a, c) });
                else if (z(c) && !z(a)) d = c.map(function(b) { return p(a, b) });
                else if (z(a) || z(c))
    ...
    M(f, "Series/Column/ColumnDataLabel.js", [f["Core/Series/DataLabel.js"], f["Core/Series/SeriesRegistry.js"],
        ...
        (function(f) {
            ...
            var p = [];
            f.compose = function(f) { a.compose(F); - 1 === p.indexOf(f) && (p.push(f), f.prototype.alignDataLabel = z) }
        })(I || (I = {}));
        return I
    });
    ...
    M(f, "Series/Scatter/ScatterSeries.js", [f["Series/Column/ColumnSeries.js"], f["Series/Line/LineSeries.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, C, G) {
        var u = this && this.__extends || function() {
                var a = function(f, m) {
                    a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array &&
                        function(a, d) { a.__proto__ = d } || function(a, d) { for (var e in d) d.hasOwnProperty(e) && (a[e] = d[e]) };
                    return a(f, m)
                };
                return function(f, m) {
        ...
        G = function(a) {
            ...
            p.prototype.drawGraph = function() { this.options.lineWidth ? a.prototype.drawGraph.call(this) : this.graph && (this.graph = this.graph.destroy()) };
        ...
        I(G.prototype, { drawTracker: a.prototype.drawTracker, sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], takeOrdinalPosition: !1 });
        F(G, "afterTranslate", function() { this.applyJitter() });
    ...
    M(f, "Series/Pie/PiePoint.js", [f["Core/Animation/AnimationUtilities.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]], function(a, f, C) {
        ...
        f = function(a) {
            ...
            e.prototype.haloPath = function(a) {
                ...
                return this.sliced ||
                    !this.visible ? [] : this.series.chart.renderer.symbols.arc(d.x, d.y, d.r + a, d.r + a, { innerR: d.r - 1, start: d.start, end: d.end })
            };
            e.prototype.init = function() {
                var d = this;
                a.prototype.init.apply(this, arguments);
                this.name = z(this.name, "Slice");
                var e = function(a) { d.slice("select" === a.type) };
                H(this, "select", e);
                H(this, "unselect", e);
                return this
            };
            e.prototype.isValid = function() { return B(this.y) && 0 <= this.y };
            e.prototype.setVisible = function(a, e) {
                ...
                e = z(e, l);
                a !== this.visible &&
                    (this.visible = this.options.visible = a = "undefined" === typeof a ? !this.visible : a, f.options.data[f.data.indexOf(this)] = this.options, ["graphic", "dataLabel", "connector", "shadowGroup"].forEach(function(e) { if (d[e]) d[e][a ? "show" : "hide"](a) }), this.legendItem && m.legend.colorizeItem(this, a), a || "hover" !== this.state || this.setState(""), l && (f.isDirty = !0), e && m.redraw())
            };
        ...
        a(f.prototype, {
            connectorShapes: {
                fixedOffset: function(a, e, d) {
                    ...
                    e = e.touchingSliceAt;
                    return [
                        ["M", a.x, a.y], d.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * f.x - e.x, 2 * f.y - e.y, f.x, f.y] : ["L", f.x, f.y],
                        ["L", e.x, e.y]
                    ]
                },
    ...
    M(f, "Series/Pie/PieSeries.js", [f["Series/CenteredUtilities.js"], f["Series/Column/ColumnSeries.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Series/Pie/PiePoint.js"], f["Core/Series/Series.js"],
        f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Utilities.js"]
        ...
        z = function(a) {
            ...
            d.prototype.animate = function(a) {
                ...
                a || e.forEach(function(a) {
                    var c = a.graphic,
                        b = a.shapeArgs;
                    c && b && (c.attr({ r: t(a.startR, d.center && d.center[3] / 2), start: f, end: f }), c.animate({ r: b.r, start: b.start, end: b.end },
                        d.options.animation))
                })
            };
            d.prototype.drawEmpty = function() {
                ...
                if (0 === this.total && this.center) {
                    ...
                    this.graph.attr({ d: B.arc(f, c, this.center[2] / 2, 0, { start: a, end: d, innerR: this.center[3] / 2 }) });
            ...
            d.prototype.getX = function(a, d, f) {
                var h = this.center,
                    c = this.radii ? this.radii[f.index] ||
                    0 : h[2] / 2;
            ...
            d.prototype.sortByAngle = function(a, d) { a.sort(function(a, e) { return "undefined" !== typeof a.angle && (e.angle - a.angle) * d }) };
            d.prototype.translate = function(a) {
                ...
                for (u = 0; u < p; u++) {
                    ...
                    var z = g + w * c;
                    var B = { x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: Math.round(1E3 * y) / 1E3, end: Math.round(1E3 * z) / 1E3 };
                    v.shapeType = "arc";
                    v.shapeArgs = B;
                    ...
                    v.labelPosition = { natural: { x: a[0] + B + Math.cos(z) * v.labelDistance, y: a[1] + F + Math.sin(z) * v.labelDistance }, "final": {}, alignment: 0 > v.labelDistance ? "center" : v.half ? "right" : "left", connectorPosition: { breakAt: { x: a[0] + B + Math.cos(z) * y, y: a[1] + F + Math.sin(z) * y }, touchingSliceAt: { x: a[0] + B, y: a[1] + F } } }
                }
            ...
            d.prototype.updateTotals = function() {
                var a = this.points,
                    ...
                    f, c = 0;
                for (f = 0; f < d; f++) { var g = a[f];!g.isValid() || e && !g.visible || (c += g.y) }
                this.total = c;
        ...
        (function(f) {
            function h() {
                var a = this,
                    ...
                    F, C, G, H, M, E, T, N, U, V, X, S;
                a.visible && (g.enabled || a._hasPointLabels) && (f.forEach(function(a) { a.dataLabel && a.visible && a.dataLabel.shortened && (a.dataLabel.attr({ width: "auto" }).css({ width: "auto", textOverflow: "clip" }), a.dataLabel.shortened = !1) }), B.prototype.drawDataLabels.apply(a),
                    f.forEach(function(a) { a.dataLabel && (a.visible ? (A[a.half].push(a), a.dataLabel._pos = null, !m(g.style.width) && !m(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > p && (a.dataLabel.css({ width: Math.round(.7 * p) + "px" }), a.dataLabel.shortened = !0)) : (a.dataLabel = a.dataLabel.destroy(), a.dataLabels && 1 === a.dataLabels.length && delete a.dataLabels)) }), A.forEach(function(e, f) {
                        var k = e.length,
                            q = [],
                            p;
                        if (k) {
                            ...
                            if (0 < a.maxLabelDistance) {
                                ...
                                e.forEach(function(a) { 0 < a.labelDistance && a.dataLabel && (a.top = Math.max(0, v - u - a.labelDistance), a.bottom = Math.min(v + u + a.labelDistance, c.plotHeight), p = a.dataLabel.getBBox().height || 21, a.distributeBox = { target: a.labelPosition.natural.y - a.top + p / 2, size: p, rank: a.y }, q.push(a.distributeBox)) });
                                r = A + p - r;
                                I(q, r, r / 5)
                            }
                            for (X = 0; X < k; X++) {
                    ...
                    if (C = d(S.connectorWidth, 1)) {
                        ...
                        if ((H = b.dataLabel) && H._pos && b.visible &&
                            ...
                            if (f = !G) b.connector = G = c.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + b.colorIndex + (b.className ? " " + b.className : "")).add(a.dataLabelsGroup), c.styledMode || G.attr({ "stroke-width": C, stroke: S.connectorColor || b.color || "#666666" });
            ...
            function t() {
                this.points.forEach(function(a) {
                    ...
                    d && a.visible && ((c = d._pos) ? (d.sideOverflow &&
                        (d._attr.width = Math.max(d.getBBox().width - d.sideOverflow, 0), d.css({ width: d._attr.width + "px", textOverflow: (this.options.dataLabels.style || {}).textOverflow || "ellipsis" }), d.shortened = !0), d.attr(d._attr), d[d.moved ? "animate" : "attr"](c), d.moved = !0) : d && d.attr({ y: -9999 }));
            ...
            function u(a) {
                ...
                if (!f) {
                    ...
                    else h = Math.max(d[2] - a[1] - a[3], b), d[0] += (a[3] - a[1]) /
                        2;
            ...
            var y = [],
                A = {
                    ...
                    radialDistributionX: function(a, d, c, e) { return a.getX(c < d.top + 2 || c > d.bottom - 2 ? e : c, d.half, d) },
                    justify: function(a, d, c) { return c[0] + (a.half ? -1 : 1) * (d + a.labelDistance) },
            ...
            f.compose = function(d) { a.compose(B); - 1 === y.indexOf(d) && (y.push(d), d = d.prototype, d.dataLabelPositioners = A, d.alignDataLabel = F, d.drawDataLabels = h, d.placeDataLabels = t, d.verifyDataLabelOverflow = u) }
        })(h || (h = {}));
        return h
    });
    M(f, "Extensions/OverlappingDataLabels.js", [f["Core/Chart/Chart.js"], f["Core/Utilities.js"]], function(a, f) {
        function F(a, f) {
            ...
            if (a) {
                var d =
                    a.newOpacity;
                a.oldOpacity !== d && (a.alignAttr && a.placed ? (a[d ? "removeClass" : "addClass"]("highcharts-data-label-hidden"), e = !0, a.alignAttr.opacity = d, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, function() { f.styledMode || a.css({ pointerEvents: d ? "auto" : "none" }) }), u(f, "afterHideOverlappingLabel")) : a.attr({ opacity: d }));
                a.isOld = !0
            }
            return e
        }
        ...
        a.prototype.hideOverlappingLabels = function(a) {
            ...
            var v = function(a) {
                ...
                if (a && (!a.alignAttr || a.placed)) {
                    ...
                    a.width || (e = a.getBBox(), a.width = e.width, a.height = e.height, e = d.fontMetrics(null,
                        a.element).h);
                    var l = a.width - 2 * f;
                    (g = { left: "0", center: "0.5", right: "1" }[a.alignValue]) ? c = +g * l: I(a.x) && Math.round(a.x) !== a.translateX && (c = a.x - a.translateX);
                    return { x: b.x + (h.translateX || 0) + f - (c || 0), y: b.y + (h.translateY || 0) + f - e, width: a.width - 2 * f, height: a.height - 2 * f }
                }
            };
            for (h = 0; h < e; h++)
                if (l = a[h]) l.oldOpacity = l.opacity, l.newOpacity = 1, l.absoluteBox = v(l);
            a.sort(function(a, d) { return (d.labelrank || 0) - (a.labelrank || 0) });
            for (h = 0; h < e; h++) {
            ...
            a.forEach(function(a) { F(a, f) && (n = !0) });
        ...
        (function(a) {
            ...
            var e = function() {
                    ...
                    function d(a, f, h, k) {
                        ...
                        I(a, function(a, b) {
                            if (!k && -1 < e.collectionsWithUpdate.indexOf(b) && f[b])
                                for (a = z(a), h[b] = [], c = 0; c < Math.max(a.length, f[b].length); c++) f[b][c] && (void 0 === a[c] ? h[b][c] = f[b][c] : (h[b][c] = {}, d(a[c], f[b][c], h[b][c], k + 1)));
                ...
                a.prototype.matchResponsiveRule =
                    function(a, d) {
                        var e = a.condition;
                        (e.callback || function() { return this.chartWidth <= B(e.maxWidth, Number.MAX_VALUE) && this.chartHeight <= B(e.maxHeight, Number.MAX_VALUE) && this.chartWidth >= B(e.minWidth, 0) && this.chartHeight >= B(e.minHeight, 0) }).call(this) && d.push(a._id)
                    };
                a.prototype.setResponsive = function(a, d) {
                    ...
                    d = H.apply(void 0,
                        l.map(function(a) { return C((f || {}).rules || [], function(d) { return d._id === a }) }).map(function(a) { return a && a.chartOptions }));
                    d.isResponsiveOptions = !0;
                    l = l.toString() || void 0;
                    l !== (h && h.ruleIds) && (h && this.update(h.undoOptions, a, !0), l ? (h = this.currentOptions(d), h.isResponsiveOptions = !0, this.currentResponsive = { ruleIds: l, mergedOptions: d, undoOptions: h }, this.update(d, a, !0)) : this.currentResponsive = void 0)
                };
                return a
            }()
        })(m || (m = {}));
    ...
    M(f, "masters/highcharts.src.js", [f["Core/Globals.js"], f["Core/Utilities.js"],
        ...
        f["Core/Tooltip.js"], f["Core/Series/Point.js"], f["Core/Pointer.js"], f["Core/MSPointer.js"], f["Core/Legend/Legend.js"], f["Core/Chart/Chart.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Series/Column/ColumnSeries.js"], f["Series/Column/ColumnDataLabel.js"], f["Series/Pie/PieSeries.js"], f["Series/Pie/PieDataLabel.js"], f["Core/Series/DataLabel.js"], f["Core/Responsive.js"], f["Core/Color/Color.js"], f["Core/Time.js"]
    ], function(a, f, C, G, u, H, I, B, z, p, m, e, d, l, h, t, n, v, w, y, A, q, k, c, g, b, r, x,
        D, K, M, Q, O) {
        a.animate = u.animate;
